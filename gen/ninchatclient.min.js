...
$packages["ninchatclient"]=(function(){var $pkg={},A=$packages["errors"],B=$packages["github.com/gopherjs/gopherjs/js"],C=$packages["sort"],D,L,AR,AU,AV,AX,AY,BA,BD,AF,AP,AT,E,F,G,H,I,J,K,M,N,O,P,Q,R,S,T,U,V,W,X,Y,Z,AA,AB,AC,AD,AE,AG,AH,AI,AJ,AK,AL,AM,AN,AO,AQ,AS,AW,AZ,BB,BC,BE,BF,BG,BH,BI,BJ;D=$pkg.Action=$newType(0,$kindStruct,"main.Action","Action","ninchatclient",function(Id_,Header_,Payload_,Deferred_,name_){this.$val=this;this.Id=Id_!==undefined?Id_:new $Uint64(0,0);this.Header=Header_!==undefined?Header_:$ifaceNil;this.Payload=Payload_!==undefined?Payload_:$ifaceNil;this.Deferred=Deferred_!==undefined?Deferred_:($ptrType(AR)).nil;this.name=name_!==undefined?name_:"";});L=$pkg.Backoff=$newType(0,$kindStruct,"main.Backoff","Backoff","ninchatclient",function(lastSlot_){this.$val=this;this.lastSlot=lastSlot_!==undefined?lastSlot_:0;});AR=$pkg.Deferred=$newType(0,$kindStruct,"main.Deferred","Deferred","ninchatclient",function(resolve_,reject_,notify_){this.$val=this;this.resolve=resolve_!==undefined?resolve_:($sliceType(B.Object)).nil;this.reject=reject_!==undefined?reject_:($sliceType(B.Object)).nil;this.notify=notify_!==undefined?notify_:($sliceType(B.Object)).nil;});AU=$pkg.Transport=$newType(4,$kindFunc,"main.Transport","Transport","ninchatclient",null);AV=$pkg.Session=$newType(0,$kindStruct,"main.Session","Session","ninchatclient",function(onSessionEvent_,onEvent_,onConnState_,onConnActive_,onLog_,address_,forceLongPoll_,sessionParams_,sessionId_,latestConnState_,latestConnActive_,lastActionId_,sendNotify_,sendBuffer_,numSent_,sendEventAck_,receivedEventId_,ackedEventId_,closeNotify_,closed_,stopped_){this.$val=this;this.onSessionEvent=onSessionEvent_!==undefined?onSessionEvent_:$ifaceNil;this.onEvent=onEvent_!==undefined?onEvent_:$ifaceNil;this.onConnState=onConnState_!==undefined?onConnState_:$ifaceNil;this.onConnActive=onConnActive_!==undefined?onConnActive_:$ifaceNil;this.onLog=onLog_!==undefined?onLog_:$ifaceNil;this.address=address_!==undefined?address_:"";this.forceLongPoll=forceLongPoll_!==undefined?forceLongPoll_:false;this.sessionParams=sessionParams_!==undefined?sessionParams_:$ifaceNil;this.sessionId=sessionId_!==undefined?sessionId_:$ifaceNil;this.latestConnState=latestConnState_!==undefined?latestConnState_:"";this.latestConnActive=latestConnActive_!==undefined?latestConnActive_:new AX(0,0);this.lastActionId=lastActionId_!==undefined?lastActionId_:new $Uint64(0,0);this.sendNotify=sendNotify_!==undefined?sendNotify_:($chanType($Bool,false,false)).nil;this.sendBuffer=sendBuffer_!==undefined?sendBuffer_:($sliceType(($ptrType(D)))).nil;this.numSent=numSent_!==undefined?numSent_:0;this.sendEventAck=sendEventAck_!==undefined?sendEventAck_:false;this.receivedEventId=receivedEventId_!==undefined?receivedEventId_:new $Uint64(0,0);this.ackedEventId=ackedEventId_!==undefined?ackedEventId_:new $Uint64(0,0);this.closeNotify=closeNotify_!==undefined?closeNotify_:($chanType($Bool,false,false)).nil;this.closed=closed_!==undefined?closed_:false;this.stopped=stopped_!==undefined?stopped_:false;});AX=$pkg.Time=$newType(8,$kindInt64,"main.Time","Time","ninchatclient",null);AY=$pkg.Duration=$newType(8,$kindInt64,"main.Duration","Duration","ninchatclient",null);BA=$pkg.Timer=$newType(0,$kindStruct,"main.Timer","Timer","ninchatclient",function(C_,id_){this.$val=this;this.C=C_!==undefined?C_:($chanType($Bool,false,false)).nil;this.id=id_!==undefined?id_:$ifaceNil;});BD=$pkg.WebSocket=$newType(0,$kindStruct,"main.WebSocket","WebSocket","ninchatclient",function(Notify_,impl_,open_,error_,buffer_){this.$val=this;this.Notify=Notify_!==undefined?Notify_:($chanType($Bool,false,false)).nil;this.impl=impl_!==undefined?impl_:$ifaceNil;this.open=open_!==undefined?open_:false;this.error=error_!==undefined?error_:$ifaceNil;this.buffer=buffer_!==undefined?buffer_:($sliceType(B.Object)).nil;});D.Ptr.prototype.Name=function(){var a;a=this;if(a.name===""){a.name=$internalize(a.Header.action,$String);}return a.name;};D.prototype.Name=function(){return this.$val.Name();};E=$pkg.GetAddress=function(a){if((a===undefined)||(a===null)){return"api.ninchat.com";}else{return $internalize(a,$String);}};F=$pkg.GetEndpointHosts=function(a){var b=($sliceType($String)).nil,c=$ifaceNil,$deferred=[],$err=null,d,e;try{$deferFrames.push($deferred);$deferred.push([(function(){var d;d=R($recover());if(!($interfaceIsEqual(d,$ifaceNil))){c=d;}}),[]]);d=a.hosts;if($parseInt(d.length)===0){c=A.New("endpoint hosts array is empty");return[b,c];}b=($sliceType($String)).make($parseInt(d.length));e=0;while(e<$parseInt(d.length)){(e<0||e>=b.$length)?$throwRuntimeError("index out of range"):b.$array[b.$offset+e]=$internalize(d[e],$String);e=e+(1)>>0;}return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};G=$pkg.GetSessionEventCredentials=function(a){var b=$ifaceNil,c=$ifaceNil,d=$ifaceNil,e=new $Uint64(0,0),f=false,g=$ifaceNil,$deferred=[],$err=null,h;try{$deferFrames.push($deferred);$deferred.push([(function(){var h;h=R($recover());if(!($interfaceIsEqual(h,$ifaceNil))){g=h;}}),[]]);if(!($internalize(a.event,$String)==="session_created")){return[b,c,d,e,f,g];}b=a.user_id;h=a.user_auth;if(!(h===undefined)){c=h;}d=a.session_id;e=$internalize(a.event_id,$Uint64);f=true;return[b,c,d,e,f,g];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c,d,e,f,g];}};H=$pkg.GetEventFrames=function(a){var b=0,c=$ifaceNil,$deferred=[],$err=null,d;try{$deferFrames.push($deferred);$deferred.push([(function(){c=R($recover());}),[]]);d=a.frames;if(!(d===undefined)){b=$parseInt(d)>>0;if(b<0){b=0;}}return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};I=$pkg.GetEventAndActionId=function(a){var b=new $Uint64(0,0),c=new $Uint64(0,0),d=$ifaceNil,$deferred=[],$err=null,e,f;try{$deferFrames.push($deferred);$deferred.push([(function(){d=R($recover());}),[]]);e=a.event_id;if(!(e===undefined)){b=$internalize(e,$Uint64);}f=a.action_id;if(!(f===undefined)){c=$internalize(f,$Uint64);}return[b,c,d];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c,d];}};J=$pkg.IsEventLastReply=function(a,b){var c=false,d=$ifaceNil,$deferred=[],$err=null,e,f,g;try{$deferFrames.push($deferred);$deferred.push([(function(){d=R($recover());}),[]]);c=true;e=a.history_length;if(!(e===undefined)){if(($parseInt(e)>>0)>0){c=false;}}if(b.name==="search"){f=a.users;g=a.channels;if(!(f===undefined)||!(g===undefined)){c=false;}}return[c,d];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[c,d];}};K=$pkg.GetEventError=function(a){var b="",c="",d=false,e=$ifaceNil,$deferred=[],$err=null,f,g;try{$deferFrames.push($deferred);$deferred.push([(function(){var f;f=R($recover());if(!($interfaceIsEqual(f,$ifaceNil))){e=f;}}),[]]);if(!($internalize(a.event,$String)==="error")){return[b,c,d,e];}b=$internalize(a.error_type,$String);f=a.error_reason;if(!(f===undefined)){c=$internalize(f,$String);}g=b;if(g==="session_not_found"){d=true;if(!(c==="")){e=A.New("error: "+b+" ("+c+")");}else{e=A.New("error: "+b);}}else if(g==="connection_superseded"||g==="message_has_too_many_parts"||g==="message_part_too_long"||g==="message_too_long"||g==="request_malformed"){if(!(c==="")){e=A.New("error: "+b+" ("+c+")");}else{e=A.New("error: "+b);}}return[b,c,d,e];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c,d,e];}};L.Ptr.prototype.Success=function(){var a;a=this;a.lastSlot=0;};L.prototype.Success=function(){return this.$val.Success();};L.Ptr.prototype.Failure=function(a){var b=new AY(0,0),c;c=this;if(c.lastSlot>0){b=new AY(0,O($flatten64(a)*c.lastSlot/1024,-0.5));}if(c.lastSlot<1023){c.lastSlot=((((c.lastSlot+1>>0))<<1>>0))-1>>0;}return b;};L.prototype.Failure=function(a){return this.$val.Failure(a);};M=$pkg.Call=function(a,b,c){var d=$ifaceNil,e,f,g;e="https://"+E(c)+"/v2/call";f=AS();g=f[0];d=new($mapType($String,$emptyInterface))(f[1]);$go((function($b){var $this=this,$args=arguments,$r,$s=0,h,i,j,k,l;if(!$b){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:h=AH(e,a,P(new AY(0,11000),0.1));i=h[0];j=h[1];if(!($interfaceIsEqual(j,$ifaceNil))){AK("NinchatClient.call onLog callback",b,new($sliceType($emptyInterface))([new $String("call:"),j]));g.Reject(new($sliceType($emptyInterface))([]));return;}k=$recv(i,true);$s=1;case 1:if(k&&k.$blocking){k=k();}l=k[0];if(!(l===$ifaceNil)){}else{$s=2;continue;}g.Resolve(new($sliceType($emptyInterface))([l]));$s=3;continue;case 2:g.Reject(new($sliceType($emptyInterface))([]));case 3:case-1:}return;}};$f.$blocking=true;return $f;}),[]);return d;};N=$pkg.PostCall=function(a,b,c){var d=($chanType(B.Object,false,false)).nil,e=$ifaceNil,$deferred=[],$err=null,f,g,h,i;try{$deferFrames.push($deferred);$deferred.push([(function(){e=R($recover());}),[]]);f=AB(a);g=f[0];e=f[1];if(!($interfaceIsEqual(e,$ifaceNil))){return[d,e];}h="https://"+c+"/v2/call";d=new($chanType(B.Object,false,false))(1);i=new($global.XMLHttpRequest)();i.onload=$externalize((function(){var $deferred=[],$err=null,j,k,l,m;try{$deferFrames.push($deferred);$deferred.push([(function(){var j;j=$recover();if(!($interfaceIsEqual(j,$ifaceNil))){console.log(j);}}),[]]);j=$ifaceNil;if(($parseInt(i.status)>>0)===200){k=AA($internalize(i.response,$String));l=k[0];m=k[1];if(!($interfaceIsEqual(m,$ifaceNil))){b(new($sliceType($emptyInterface))([m]));}else{j=V();j.push(l);}}else{b(new($sliceType($emptyInterface))([new $String("call status"),new $String($internalize(i.status,$String))]));}$go((function($b){var $this=this,$args=arguments,$r,$s=0;if(!$b){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:$r=$send(d,j,true);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[]);}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);}}),($funcType([],[],false)));i.open($externalize("POST",$String),$externalize(h,$String),$externalize(true,$Bool));i.setRequestHeader($externalize("Content-Type",$String),$externalize("application/json",$String));i.send($externalize(g,$String));return[d,e];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[d,e];}};O=$pkg.Jitter=function(a,b){return a+a*b*AC();};P=$pkg.JitterDuration=function(a,b){return new AY(0,O($flatten64(a),b));};Q=$pkg.JitterUint64=function(a,b){return new $Uint64(0,O($flatten64(a),b));};R=function(a){var b=$ifaceNil,c,d,e,f;if($interfaceIsEqual(a,$ifaceNil)){return b;}c=$assertType(a,($ptrType(B.Error)),true);d=c[0];e=c[1];if(e){f=$internalize(d.Object.message,$String);if(f===""){f="error";}b=A.New(f);return b;}b=$assertType(a,$error);return b;};S=function(a,b,c){var d=false,$deferred=[],$err=null;try{$deferFrames.push($deferred);$deferred.push([(function(){var e;e=R($recover());if(!($interfaceIsEqual(e,$ifaceNil))){console.log(a+" invocation error: "+e.Error());}}),[]]);b.apply(undefined,$externalize(c,($sliceType($emptyInterface))));d=true;return d;}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return d;}};T=$pkg.Atob=function(a){var b=$ifaceNil,c=$ifaceNil,$deferred=[],$err=null;try{$deferFrames.push($deferred);$deferred.push([(function(){c=R($recover());}),[]]);b=$global.atob(a);return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};U=$pkg.ParseDataURI=function(a){var b=$ifaceNil,c=$ifaceNil,$deferred=[],$err=null;try{$deferFrames.push($deferred);$deferred.push([(function(){c=R($recover());}),[]]);b=a.split($externalize(",",$String))[1];return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};V=$pkg.NewArray=function(){return new($global.Array)();};W=$pkg.NewArrayBuffer=function(a){return new($global.ArrayBuffer)(a);};X=$pkg.NewUint8Array=function(a){return new($global.Uint8Array)(a);};Y=$pkg.NewObject=function(){return new($global.Object)();};Z=$pkg.EncodeURIComponent=function(a){return $internalize($global.encodeURIComponent($externalize(a,$String)),$String);};AA=$pkg.ParseJSON=function(a){var b=$ifaceNil,c=$ifaceNil,$deferred=[],$err=null;try{$deferFrames.push($deferred);$deferred.push([(function(){c=R($recover());}),[]]);b=$global.JSON.parse($externalize(a,$String));return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};AB=$pkg.StringifyJSON=function(a){var b="",c=$ifaceNil,$deferred=[],$err=null;try{$deferFrames.push($deferred);$deferred.push([(function(){c=R($recover());}),[]]);b=$internalize($global.JSON.stringify($externalize(a,$emptyInterface)),$String);return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};AC=$pkg.Random=function(){return $parseFloat($global.Math.random());};AD=$pkg.SetTimeout=function(a,b){var c=$ifaceNil;c=$global.setTimeout($externalize(a,($funcType([],[],false))),$externalize(b,AY));return c;};AE=$pkg.ClearTimeout=function(a){$global.clearTimeout(a);};AG=$pkg.JSONP=function(a,b){var c=($chanType(B.Object,false,false)).nil,d=$ifaceNil,e;e=AJ(a+"?callback=",b);c=e[0];d=e[1];return[c,d];};AH=$pkg.DataJSONP=function(a,b,c){var d=($chanType(B.Object,false,false)).nil,e=$ifaceNil,f,g,h;f=AB(b);g=f[0];e=f[1];if(!($interfaceIsEqual(e,$ifaceNil))){return[d,e];}h=AI(a,g,c);d=h[0];e=h[1];return[d,e];};AI=$pkg.StringJSONP=function(a,b,c){var d=($chanType(B.Object,false,false)).nil,e=$ifaceNil,f;f=AJ(a+"?data="+Z(b)+"&callback=",c);d=f[0];e=f[1];return[d,e];};AJ=function(a,b){var c=($chanType(B.Object,false,false)).nil,d=$ifaceNil,$deferred=[],$err=null,e,f,g,h,i,j,k,l;try{$deferFrames.push($deferred);$deferred.push([(function(){d=R($recover());}),[]]);e=AB(new $Int(AF));f=e[0];AF=((AF+1>>0))&2147483647;g="_callback"+f;h="NinchatClient."+g;c=new($chanType(B.Object,false,false))(1);i=AD((function(){delete AP[$externalize(g,$String)];$go((function(){$close(c);}),[]);}),b);AP[$externalize(g,$String)]=$externalize((function(j){AE(i);delete AP[$externalize(g,$String)];$go((function($b){var $this=this,$args=arguments,$r,$s=0;if(!$b){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:$r=$send(c,j,true);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[]);}),($funcType([B.Object],[],false)));j=$global.document;k=j.createElement($externalize("script",$String));k.type=$externalize("text/javascript",$String);k.async=$externalize(true,$Bool);k.src=$externalize(a+h,$String);l=j.getElementsByTagName($externalize("head",$String))[0];l.appendChild(k);return[c,d];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[c,d];}};AK=$pkg.Log=function(a,b,c){var d,e,f,g,h,i,j,k,l,m,n;if(b===$ifaceNil||(b===undefined)||(b===null)){return;}d="";e=c;f=0;while(f<e.$length){g=((f<0||f>=e.$length)?$throwRuntimeError("index out of range"):e.$array[e.$offset+f]);h="?";i=$assertType(g,$String,true);j=i[0];k=i[1];if(k){h=j;}else{l=$assertType(g,$error,true);m=l[0];n=l[1];if(n){h=m.Error();}}if(d.length>0){d=d+(" ");}d=d+(h);f++;}while(d.length>0&&(d.charCodeAt((d.length-1>>0))===32)){d=d.substring(0,(d.length-1>>0));}S(a,b,new($sliceType($emptyInterface))([new $String(d)]));};AL=$pkg.LongPollTransport=function(a,b,$b){var $this=this,$args=arguments,c=false,d=false,$r,$deferred=[],$err=null,$s=0,e,f,g,h,i,j,k,l,m,n,o;if(!$b){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);s:while(true){switch($s){case 0:$deferred.push([(function(){var e;e=R($recover());if(!($interfaceIsEqual(e,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("poll:"),e]));}}),[true]]);c=true;e="https://"+b+"/v2/poll";if(a.sessionId===$ifaceNil){}else{$s=1;continue;}a.log(new($sliceType($emptyInterface))([new $String("session creation")]));f=a.makeCreateSessionAction();g=AH(e,f,P(new AY(0,13000),0.2));h=g[0];i=g[1];if(!($interfaceIsEqual(i,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("session creation:"),i]));return[c,d];}k=$select([[h],[a.closeNotify]],true);$s=3;case 3:if(k&&k.$blocking){k=k();}j=k;if(j[0]===0){l=j[1][0];if(l===$ifaceNil){a.log(new($sliceType($emptyInterface))([new $String("session creation timeout")]));return[c,d];}m=l[0];if(!a.handleSessionEvent(m)){return[c,d];}}else if(j[0]===1){AO(a,e);return[c,d];}d=true;a.connState("connected");a.connActive();$s=2;continue;case 1:a.log(new($sliceType($emptyInterface))([new $String("session resumption")]));n=AN(a,e);if(!($interfaceIsEqual(n,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("session resumption:"),n]));return[c,d];}case 2:o=AM(a,e,true);$s=4;case 4:if(o&&o.$blocking){o=o();}if(o){}else{$s=5;continue;}d=true;case 5:return[c,d];case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);return[c,d];}};$f.$blocking=true;return $f;};AM=function(a,b,$b){var $this=this,$args=arguments,c=false,$r,$s=0,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,aa,ab,ac,ad,ae,af,ag,ah,ai,aj,ak,al,am,an,ao;if(!$b){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:d=($chanType(B.Object,false,true)).nil;e=($chanType(B.Object,false,true)).nil;f=new $Uint64(0,0);g=0;a.numSent=0;case 1:if(!(g<2)){$s=2;continue;}if(d===($chanType(B.Object,false,true)).nil){h=$ifaceNil;i=a.makeResumeSessionAction(true);j=AH(b,i,P(new AY(0,64000),0.2));d=j[0];h=j[1];if(!($interfaceIsEqual(h,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("poll:"),h]));return c;}}if(e===($chanType(B.Object,false,true)).nil&&a.numSent<a.sendBuffer.$length){m=(k=a.sendBuffer,l=a.numSent,((l<0||l>=k.$length)?$throwRuntimeError("index out of range"):k.$array[k.$offset+l]));if(!(m.Payload===$ifaceNil)){n=$ifaceNil;o=$ifaceNil;p=m.Payload[0];if($internalize(m.Header.action,$String)==="update_user"){q=U(p);r=q[0];s=q[1];if(!($interfaceIsEqual(s,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("send:"),s]));return c;}n=V();n.push(r);}else{t=AA($internalize(p,$String));n=t[0];o=t[1];if(!($interfaceIsEqual(o,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("send:"),o]));return c;}}m.Header.payload=n;}m.Header.session_id=a.sessionId;u=AB(m.Header);v=u[0];w=u[1];delete m.Header[$externalize("session_id",$String)];if(!($interfaceIsEqual(w,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("send:"),w]));return c;}x=($chanType(B.Object,false,false)).nil;if(v.length<=2048){y=AI(b,v,P(new AY(0,7000),0.2));x=y[0];w=y[1];}else{m.Header.caller_id=a.sessionParams.user_id;m.Header.caller_auth=a.sessionParams.user_auth;z=N(m.Header,$methodVal(a,"log"),a.address);x=z[0];w=z[1];delete m.Header[$externalize("caller_id",$String)];delete m.Header[$externalize("caller_auth",$String)];}delete m.Header[$externalize("payload",$String)];if(!($interfaceIsEqual(w,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("send:"),w]));return c;}if((aa=m.Id,(aa.$high===0&&aa.$low===0))){a.sendBuffer=$appendSlice($subslice(a.sendBuffer,0,a.numSent),$subslice(a.sendBuffer,(a.numSent+1>>0)));}else{e=x;f=m.Id;}}ab=$ifaceNil;ad=$select([[d],[e],[a.sendNotify],[a.closeNotify]],true);$s=3;case 3:if(ad&&ad.$blocking){ad=ad();}ac=ad;if(ac[0]===0){ab=ac[1][0];if(ab===$ifaceNil){a.log(new($sliceType($emptyInterface))([new $String("poll timeout")]));}d=($chanType(B.Object,false,true)).nil;a.connActive();}else if(ac[0]===1){ab=ac[1][0];if(ab===$ifaceNil){a.log(new($sliceType($emptyInterface))([new $String("send timeout")]));}else if((f.$high>0||(f.$high===0&&f.$low>0))){a.numSent=a.numSent+(1)>>0;}e=($chanType(B.Object,false,true)).nil;f=new $Uint64(0,0);}else if(ac[0]===2){ae=ac[1][0];if(!ae){AO(a,b);return c;}$s=1;continue;}else if(ac[0]===3){AO(a,b);return c;}if(ab===$ifaceNil){g=g+(1)>>0;a.numSent=0;$s=1;continue;}g=0;af=0;while(af<$parseInt(ab.length)){ag=ab[af];ah=V();ai=ag.payload;if(!(ai===undefined)){aj=AB(ai);ak=aj[0];al=aj[1];if(!($interfaceIsEqual(al,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("poll payload:"),al]));return c;}ah.push($externalize(ak,$String));}am=a.handleEvent(ag,ah);an=am[0];ao=am[2];if((f.$high>0||(f.$high===0&&f.$low>0))&&(f.$high<an.$high||(f.$high===an.$high&&f.$low<=an.$low))){f=new $Uint64(0,0);a.numSent=a.numSent+(1)>>0;}if(!ao){return c;}if(!c){c=true;a.connState("connected");}af=af+(1)>>0;}$s=1;continue;case 2:return c;case-1:}return;}};$f.$blocking=true;return $f;};AN=function(a,b){var c=$ifaceNil,d,e,f,g;d=(e=new $Map(),f="action",e[f]={k:f,v:new $String("ping")},f="session_id",e[f]={k:f,v:a.sessionId},e);g=AH(b,new($mapType($String,$emptyInterface))(d),P(new AY(0,7000),0.9));c=g[1];return c;};AO=function(a,b){var c,d,e,f,g;c=(d=new $Map(),e="action",d[e]={k:e,v:new $String("close_session")},e="session_id",d[e]={k:e,v:a.sessionId},d);f=AH(b,new($mapType($String,$emptyInterface))(c),P(new AY(0,7000),0.9));g=f[1];if(!($interfaceIsEqual(g,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("send:"),g]));}};AQ=function(){AP.call=$externalize(M,($funcType([B.Object,B.Object,B.Object],[$emptyInterface],false)));AP.newSession=$externalize(AW,($funcType([],[($mapType($String,$emptyInterface))],false)));AP.stringifyFrame=$externalize(BF,($funcType([B.Object],[$String],false)));$global.NinchatClient=AP;};AS=$pkg.Defer=function(){var a=($ptrType(AR)).nil,b=false,c,d;a=new AR.Ptr(($sliceType(B.Object)).nil,($sliceType(B.Object)).nil,($sliceType(B.Object)).nil);b=(c=new $Map(),d="then",c[d]={k:d,v:new($funcType([B.Object,B.Object,B.Object],[],false))($methodVal(a,"then"))},c);return[a,b];};AR.Ptr.prototype.then=function(a,b,c){var d;d=this;if(!(a===undefined)&&!(a===null)){d.resolve=$append(d.resolve,a);}if(!(b===undefined)&&!(b===null)){d.reject=$append(d.reject,b);}if(!(c===undefined)&&!(c===null)){d.notify=$append(d.notify,c);}};AR.prototype.then=function(a,b,c){return this.$val.then(a,b,c);};AR.Ptr.prototype.Resolve=function(a){var b,c,d,e;b=this;c=b.resolve;d=0;while(d<c.$length){e=((d<0||d>=c.$length)?$throwRuntimeError("index out of range"):c.$array[c.$offset+d]);S("NinchatClient promise resolve callback",e,a);d++;}};AR.prototype.Resolve=function(a){return this.$val.Resolve(a);};AR.Ptr.prototype.Reject=function(a){var b,c,d,e;b=this;c=b.reject;d=0;while(d<c.$length){e=((d<0||d>=c.$length)?$throwRuntimeError("index out of range"):c.$array[c.$offset+d]);S("NinchatClient promise reject callback",e,a);d++;}};AR.prototype.Reject=function(a){return this.$val.Reject(a);};AR.Ptr.prototype.Notify=function(a){var b,c,d,e;b=this;c=b.notify;d=0;while(d<c.$length){e=((d<0||d>=c.$length)?$throwRuntimeError("index out of range"):c.$array[c.$offset+d]);S("NinchatClient promise notify callback",e,a);d++;}};AR.prototype.Notify=function(a){return this.$val.Notify(a);};AW=$pkg.NewSession=function(){var a,b,c;a=new AV.Ptr($ifaceNil,$ifaceNil,$ifaceNil,$ifaceNil,$ifaceNil,"api.ninchat.com",false,$ifaceNil,$ifaceNil,"",new AX(0,0),new $Uint64(0,0),($chanType($Bool,false,false)).nil,($sliceType(($ptrType(D)))).nil,0,false,new $Uint64(0,0),new $Uint64(0,0),($chanType($Bool,false,false)).nil,false,true);return(b=new $Map(),c="onSessionEvent",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"OnSessionEvent"))},c="onEvent",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"OnEvent"))},c="onConnState",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"OnConnState"))},c="onConnActive",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"OnConnActive"))},c="onLog",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"OnLog"))},c="setParams",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"SetParams"))},c="setTransport",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"SetTransport"))},c="setAddress",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"SetAddress"))},c="open",b[c]={k:c,v:new($funcType([],[],false))($methodVal(a,"Open"))},c="close",b[c]={k:c,v:new($funcType([],[],false))($methodVal(a,"Close"))},c="send",b[c]={k:c,v:new($funcType([B.Object,B.Object],[$emptyInterface],false))($methodVal(a,"Send"))},b);};AV.Ptr.prototype.OnSessionEvent=function(a){var b;b=this;b.onSessionEvent=a;};AV.prototype.OnSessionEvent=function(a){return this.$val.OnSessionEvent(a);};AV.Ptr.prototype.OnEvent=function(a){var b;b=this;b.onEvent=a;};AV.prototype.OnEvent=function(a){return this.$val.OnEvent(a);};AV.Ptr.prototype.OnConnState=function(a){var b;b=this;if(a===null){a=$ifaceNil;}b.onConnState=a;if(!(b.onConnState===$ifaceNil)&&!(b.latestConnState==="")){S("NinchatClient.Session onConnState callback",b.onConnState,new($sliceType($emptyInterface))([new $String(b.latestConnState)]));}};AV.prototype.OnConnState=function(a){return this.$val.OnConnState(a);};AV.Ptr.prototype.OnConnActive=function(a){var b,c;b=this;if(a===null){a=$ifaceNil;}b.onConnActive=a;if(!(b.onConnActive===$ifaceNil)&&(c=b.latestConnActive,(c.$high>0||(c.$high===0&&c.$low>0)))){S("NinchatClient.Session onConnActive callback",b.onConnActive,new($sliceType($emptyInterface))([b.latestConnActive]));}};AV.prototype.OnConnActive=function(a){return this.$val.OnConnActive(a);};AV.Ptr.prototype.OnLog=function(a){var b;b=this;if(a===null){a=$ifaceNil;}b.onLog=a;};AV.prototype.OnLog=function(a){return this.$val.OnLog(a);};AV.Ptr.prototype.SetParams=function(a){var b,c;b=this;if(a.message_types===undefined){$panic(new $String("message_types parameter not defined"));}c=a.session_id;if(!(c===undefined)&&!(c===null)){b.sessionId=c;}delete a[$externalize("session_id",$String)];b.sessionParams=a;if(!(b.sendNotify===($chanType($Bool,false,false)).nil)&&b.stopped){$go($methodVal(b,"discover"),[]);}};AV.prototype.SetParams=function(a){return this.$val.SetParams(a);};AV.Ptr.prototype.SetTransport=function(a){var b,c,d;b=this;if(a===null){b.forceLongPoll=false;return;}c=$internalize(a,$String);d=c;if(d==="websocket"){$panic(new $String("websocket transport cannot be forced"));}else if(d==="longpoll"){b.forceLongPoll=true;}else{$panic(new $String("unknown transport: "+c));}};AV.prototype.SetTransport=function(a){return this.$val.SetTransport(a);};AV.Ptr.prototype.SetAddress=function(a){var b;b=this;b.address=E(a);};AV.prototype.SetAddress=function(a){return this.$val.SetAddress(a);};AV.Ptr.prototype.Open=function(){var a;a=this;if(a.closed){$panic(new $String("session already closed"));}if(!(a.sendNotify===($chanType($Bool,false,false)).nil)){$panic(new $String("session already initialized"));}if(a.onSessionEvent===$ifaceNil){$panic(new $String("onSessionEvent callback not defined"));}if(a.onEvent===$ifaceNil){$panic(new $String("onEvent callback not defined"));}if(a.sessionParams===$ifaceNil){$panic(new $String("session parameters not defined"));}a.sendNotify=new($chanType($Bool,false,false))(1);a.closeNotify=new($chanType($Bool,false,false))(1);a.stopped=false;$go($methodVal(a,"discover"),[]);};AV.prototype.Open=function(){return this.$val.Open();};AV.Ptr.prototype.Close=function(){var a,b,c,d;a=this;if(a.closed){return;}b=a.sendBuffer;c=0;while(c<b.$length){d=((c<0||c>=b.$length)?$throwRuntimeError("index out of range"):b.$array[b.$offset+c]);if(!(d.Deferred===($ptrType(AR)).nil)){d.Deferred.Reject(new($sliceType($emptyInterface))([]));}c++;}a.sendBuffer=($sliceType(($ptrType(D)))).nil;a.numSent=0;a.closed=true;a.stopped=true;$go((function($b){var $this=this,$args=arguments,$r,$s=0;if(!$b){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:$r=$send(a.closeNotify,true,true);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}$close(a.sendNotify);case-1:}return;}};$f.$blocking=true;return $f;}),[]);};AV.prototype.Close=function(){return this.$val.Close();};AV.Ptr.prototype.Send=function(a,b){var c=$ifaceNil,d,e,f,g,h;d=this;if(d.sendNotify===($chanType($Bool,false,false)).nil){$panic(new $String("session not initialized"));}if(d.closed){$panic(new $String("session already closed"));}if((b===undefined)||(b===null)||($parseInt(b.length)===0)){b=$ifaceNil;}e=new D.Ptr(new $Uint64(0,0),a,b,($ptrType(AR)).nil,"");if(a.action_id===null){delete a[$externalize("action_id",$String)];}else{d.lastActionId=(f=d.lastActionId,g=new $Uint64(0,1),new $Uint64(f.$high+g.$high,f.$low+g.$low));e.Id=d.lastActionId;a.action_id=$externalize(e.Id,$Uint64);h=AS();e.Deferred=h[0];c=new($mapType($String,$emptyInterface))(h[1]);}d.send(e);return c;};AV.prototype.Send=function(a,b){return this.$val.Send(a,b);};AV.Ptr.prototype.send=function(a){var b;b=this;b.sendBuffer=$append(b.sendBuffer,a);$go((function(){var c;c=$select([[b.sendNotify,true],[]]);}),[]);return;};AV.prototype.send=function(a){return this.$val.send(a);};AV.Ptr.prototype.sendAck=function(){var a;a=this;a.sendEventAck=true;$go((function(){var b;b=$select([[a.sendNotify,true],[]]);}),[]);};AV.prototype.sendAck=function(){return this.$val.sendAck();};AV.Ptr.prototype.discover=function($b){var $this=this,$args=arguments,$r,$deferred=[],$err=null,$s=0,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p;if(!$b){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);s:while(true){switch($s){case 0:a=$this;a.log(new($sliceType($emptyInterface))([new $String("opening")]));$deferred.push([$methodVal(a,"log"),[new($sliceType($emptyInterface))([new $String("closed")]),true]]);$deferred.push([$methodVal(a,"connState"),["disconnected",true]]);b=new L.Ptr();$copy(b,new L.Ptr(),L);c=false;case 1:if(!(!a.stopped)){$s=2;continue;}a.log(new($sliceType($emptyInterface))([new $String("endpoint discovery")]));a.connState("connecting");d="https://"+a.address+"/v2/endpoint";e=AG(d,P(new AY(0,7000),0.1));f=e[0];g=e[1];if(!($interfaceIsEqual(g,$ifaceNil))){}else{$s=3;continue;}a.log(new($sliceType($emptyInterface))([new $String("endpoint discovery:"),g]));$s=4;continue;case 3:i=$select([[f],[a.closeNotify]],true);$s=5;case 5:if(i&&i.$blocking){i=i();}h=i;if(h[0]===0){}else if(h[0]===1){$s=6;continue;}else{$s=7;continue;}j=h[1][0];if(j===$ifaceNil){}else{$s=8;continue;}a.log(new($sliceType($emptyInterface))([new $String("endpoint discovery timed out")]));$s=9;continue;case 8:k=F(j);l=k[0];m=k[1];if(!($interfaceIsEqual(m,$ifaceNil))){}else{$s=10;continue;}a.log(new($sliceType($emptyInterface))([new $String("endpoint discovery:"),m]));$s=11;continue;case 10:a.log(new($sliceType($emptyInterface))([new $String("endpoint discovered")]));if(!$pkg.WebSocketSupported||a.forceLongPoll||c){}else{$s=12;continue;}n=a.connect(AL,l,b,true);$s=14;case 14:if(n&&n.$blocking){n=n();}n;$s=13;continue;case 12:o=a.connect(BG,l,b,true);$s=15;case 15:if(o&&o.$blocking){o=o();}c=!o;case 13:$s=1;continue;case 11:case 9:$s=7;continue;case 6:return;case 7:case 4:p=b.Failure(new AY(0,60000));if((p.$high>0||(p.$high===0&&p.$low>0))){}else{$s=16;continue;}a.log(new($sliceType($emptyInterface))([new $String("sleeping")]));a.connState("disconnected");$r=BC(p,true);$s=17;case 17:if($r&&$r.$blocking){$r=$r();}case 16:$s=1;continue;case 2:case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);}};$f.$blocking=true;return $f;};AV.prototype.discover=function($b){return this.$val.discover($b);};AV.Ptr.prototype.connect=function(a,b,c,$b){var $this=this,$args=arguments,d=false,$r,$s=0,e,f,g,h,i,j,k,l,m,n;if(!$b){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:e=$this;f=0;case 1:if(!(f<2)){$s=2;continue;}g=b;h=0;case 3:if(!(h<g.$length)){$s=4;continue;}i=((h<0||h>=g.$length)?$throwRuntimeError("index out of range"):g.$array[g.$offset+h]);e.connState("connecting");k=a(e,i,true);$s=5;case 5:if(k&&k.$blocking){k=k();}j=k;l=j[0];m=j[1];if(l){d=true;}if(m){c.Success();return d;}if(e.stopped){return d;}n=c.Failure(new AY(0,60000));if((n.$high>0||(n.$high===0&&n.$low>0))){}else{$s=6;continue;}e.log(new($sliceType($emptyInterface))([new $String("sleeping")]));e.connState("disconnected");$r=BC(n,true);$s=7;case 7:if($r&&$r.$blocking){$r=$r();}case 6:h++;$s=3;continue;case 4:f=f+(1)>>0;$s=1;continue;case 2:return d;case-1:}return;}};$f.$blocking=true;return $f;};AV.prototype.connect=function(a,b,c,$b){return this.$val.connect(a,b,c,$b);};AV.Ptr.prototype.canLogin=function(){var a,b,c,d,e,f,g,h,i,j,k;a=this;b=a.sessionParams.access_key;if(!(b===undefined)&&!(b===null)){return true;}c=a.sessionParams.user_id;if(!(c===undefined)&&!(c===null)){d=new($sliceType($String))(["user_auth","master_sign"]);e=0;while(e<d.$length){f=((e<0||e>=d.$length)?$throwRuntimeError("index out of range"):d.$array[d.$offset+e]);g=a.sessionParams[$externalize(f,$String)];if(!(g===undefined)&&!(g===null)){return true;}e++;}return false;}h=new($sliceType($String))(["identity_type","identity_name","identity_auth"]);i=0;while(i<h.$length){j=((i<0||i>=h.$length)?$throwRuntimeError("index out of range"):h.$array[h.$offset+i]);k=a.sessionParams[$externalize(j,$String)];if((k===undefined)||(k===null)){return false;}i++;}return true;};AV.prototype.canLogin=function(){return this.$val.canLogin();};AV.Ptr.prototype.makeCreateSessionAction=function(){var a=$ifaceNil,b;b=this;a=b.sessionParams;a.action=$externalize("create_session",$String);return a;};AV.prototype.makeCreateSessionAction=function(){return this.$val.makeCreateSessionAction();};AV.Ptr.prototype.makeResumeSessionAction=function(a){var b=$ifaceNil,c;c=this;b=Y();b.action=$externalize("resume_session",$String);b.event_id=$externalize(c.receivedEventId,$Uint64);if(a){b.session_id=c.sessionId;}c.sendEventAck=false;c.ackedEventId=c.receivedEventId;return b;};AV.prototype.makeResumeSessionAction=function(a){return this.$val.makeResumeSessionAction(a);};AV.Ptr.prototype.handleSessionEvent=function(a){var b=false,c,d,e,f,g,h,i,j,k,l,m;c=this;d=G(a);e=d[0];f=d[1];g=d[2];h=d[3];b=d[4];i=d[5];if(!($interfaceIsEqual(i,$ifaceNil))){c.log(new($sliceType($emptyInterface))([new $String("session creation:"),i]));}if(!S("NinchatClient.Session onSessionEvent callback",c.onSessionEvent,new($sliceType($emptyInterface))([a]))){b=false;}if(!b){c.sessionId=$ifaceNil;c.stopped=true;return b;}c.sessionParams.user_id=e;if(!(f===$ifaceNil)){c.sessionParams.user_auth=f;}j=new($sliceType($String))(["identity_type","identity_name","identity_auth"]);k=0;while(k<j.$length){l=((k<0||k>=j.$length)?$throwRuntimeError("index out of range"):j.$array[j.$offset+k]);m=c.sessionParams[$externalize(l+"_new",$String)];if(!(m===undefined)){c.sessionParams[$externalize(l,$String)]=m;}k++;}delete c.sessionParams[$externalize("access_key",$String)];delete c.sessionParams[$externalize("master_sign",$String)];c.sessionId=g;if(c.sendBuffer.$length===0){c.lastActionId=new $Uint64(0,0);}c.sendEventAck=false;c.receivedEventId=h;c.ackedEventId=new $Uint64(0,0);c.log(new($sliceType($emptyInterface))([new $String("session created")]));b=true;return b;};AV.prototype.handleSessionEvent=function(a){return this.$val.handleSessionEvent(a);};AV.Ptr.prototype.handleEvent=function(a,b){var c=new $Uint64(0,0),d=false,e=false,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w;f=this;g=I(a);h=g[0];c=g[1];i=g[2];if(!($interfaceIsEqual(i,$ifaceNil))){f.log(new($sliceType($emptyInterface))([new $String("event:"),i]));return[c,d,e];}if((h.$high>0||(h.$high===0&&h.$low>0))){f.receivedEventId=h;if(!f.sendEventAck){if((j=(k=f.receivedEventId,l=f.ackedEventId,new $Uint64(k.$high-l.$high,k.$low-l.$low)),(j.$high>AT.$high||(j.$high===AT.$high&&j.$low>=AT.$low)))){f.sendAck();}else{d=true;}}}if((c.$high>0||(c.$high===0&&c.$low>0))){m=C.Search(f.numSent,(function(m){var n,o,p;o=(n=f.sendBuffer,((m<0||m>=n.$length)?$throwRuntimeError("index out of range"):n.$array[n.$offset+m]));return(p=o.Id,(p.$high>c.$high||(p.$high===c.$high&&p.$low>=c.$low)));}));if(m<f.numSent){o=(n=f.sendBuffer,((m<0||m>=n.$length)?$throwRuntimeError("index out of range"):n.$array[n.$offset+m]));if((p=o.Id,(p.$high===c.$high&&p.$low===c.$low))){q=J(a,o);r=q[0];s=q[1];if(!($interfaceIsEqual(s,$ifaceNil))){f.log(new($sliceType($emptyInterface))([new $String("event:"),s]));return[c,d,e];}if(!(o.Deferred===($ptrType(AR)).nil)){if(r){o.Deferred.Resolve(new($sliceType($emptyInterface))([a,b]));}else{o.Deferred.Notify(new($sliceType($emptyInterface))([a,b]));}}if(r){f.sendBuffer=$appendSlice($subslice(f.sendBuffer,0,m),$subslice(f.sendBuffer,(m+1>>0)));f.numSent=f.numSent-(1)>>0;}}}}t=K(a);u=t[0];v=t[1];w=t[2];i=t[3];if(!($interfaceIsEqual(i,$ifaceNil))){f.log(new($sliceType($emptyInterface))([new $String("event:"),i]));if(w){f.sessionId=$ifaceNil;if(!f.canLogin()){S("NinchatClient.Session onSessionEvent callback",f.onSessionEvent,new($sliceType($emptyInterface))([a]));f.stopped=true;}}return[c,d,e];}if(u==="deprecated"){f.log(new($sliceType($emptyInterface))([new $String("deprecated:"),new $String(v)]));}if(!S("NinchatClient.Session onEvent callback",f.onEvent,new($sliceType($emptyInterface))([a,b]))){return[c,d,e];}e=true;return[c,d,e];};AV.prototype.handleEvent=function(a,b){return this.$val.handleEvent(a,b);};AV.Ptr.prototype.connState=function(a){var b;b=this;if(!(b.latestConnState===a)){b.latestConnState=a;if(!(b.onConnState===$ifaceNil)){S("NinchatClient.Session onConnState callback",b.onConnState,new($sliceType($emptyInterface))([new $String(b.latestConnState)]));}}};AV.prototype.connState=function(a){return this.$val.connState(a);};AV.Ptr.prototype.connActive=function(){var a;a=this;a.latestConnActive=AZ();if(!(a.onConnActive===$ifaceNil)){S("NinchatClient.Session onConnActive callback",a.onConnActive,new($sliceType($emptyInterface))([a.latestConnActive]));}};AV.prototype.connActive=function(){return this.$val.connActive();};AV.Ptr.prototype.log=function(a){var b;b=this;AK("NinchatClient.Session onLog callback",b.onLog,a);};AV.prototype.log=function(a){return this.$val.log(a);};AZ=$pkg.Now=function(){var a;return(a=$internalize(new($global.Date)().getTime(),$Int64),new AX(a.$high,a.$low));};BB=$pkg.NewTimer=function(a){var b=($ptrType(BA)).nil;b=new BA.Ptr(new($chanType($Bool,false,false))(0),$ifaceNil);if((a.$high>0||(a.$high===0&&a.$low>=0))){b.Reset(a);}return b;};BA.Ptr.prototype.Active=function(){var a;a=this;return!(a.id===$ifaceNil);};BA.prototype.Active=function(){return this.$val.Active();};BA.Ptr.prototype.Reset=function(a){var b;b=this;b.Stop();b.id=AD((function(){b.id=$ifaceNil;$go((function($b){var $this=this,$args=arguments,$r,$s=0;if(!$b){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:$r=$send(b.C,true,true);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[]);}),a);};BA.prototype.Reset=function(a){return this.$val.Reset(a);};BA.Ptr.prototype.Stop=function(){var a;a=this;if(!(a.id===$ifaceNil)){AE(a.id);a.id=$ifaceNil;}};BA.prototype.Stop=function(){return this.$val.Stop();};BC=$pkg.Sleep=function(a,$b){var $this=this,$args=arguments,$r,$s=0,b;if(!$b){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:b=$recv(BB(a).C,true);$s=1;case 1:if(b&&b.$blocking){b=b();}b[0];case-1:}return;}};$f.$blocking=true;return $f;};BE=$pkg.NewWebSocket=function(a){var b=($ptrType(BD)).nil;b=new BD.Ptr(new($chanType($Bool,false,false))(1),new($global.WebSocket)($externalize(a,$String)),false,$ifaceNil,($sliceType(B.Object)).nil);b.impl.binaryType=$externalize("arraybuffer",$String);b.impl.onopen=$externalize((function(c){b.open=true;$go((function($b){var $this=this,$args=arguments,$r,$s=0;if(!$b){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:$r=$send(b.Notify,true,true);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[]);}),($funcType([B.Object],[],false)));b.impl.onmessage=$externalize((function(c){b.buffer=$append(b.buffer,c.data);$go((function(){var d;d=$select([[b.Notify,true],[]]);}),[]);}),($funcType([B.Object],[],false)));b.impl.onclose=$externalize((function(c){b.open=false;$go((function(){$close(b.Notify);}),[]);}),($funcType([B.Object],[],false)));b.impl.onerror=$externalize((function(c){b.error=A.New("WebSocket error event");}),($funcType([B.Object],[],false)));return b;};BD.Ptr.prototype.Send=function(a){var b=$ifaceNil,$deferred=[],$err=null,c;try{$deferFrames.push($deferred);c=this;$deferred.push([(function(){b=R($recover());}),[]]);b=c.error;if(!($interfaceIsEqual(b,$ifaceNil))){return b;}c.impl.send($externalize(a,$emptyInterface));return b;}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return b;}};BD.prototype.Send=function(a){return this.$val.Send(a);};BD.Ptr.prototype.SendJSON=function(a){var b=$ifaceNil,c,d,e;c=this;d=AB(a);e=d[0];b=d[1];if(!($interfaceIsEqual(b,$ifaceNil))){return b;}b=c.Send(new $String(e));return b;};BD.prototype.SendJSON=function(a){return this.$val.SendJSON(a);};BD.Ptr.prototype.Receive=function(){var a=$ifaceNil,b=$ifaceNil,c,d;c=this;b=c.error;if(!($interfaceIsEqual(b,$ifaceNil))){return[a,b];}if(!c.open){return[a,b];}if(c.buffer.$length>0){a=(d=c.buffer,((0<0||0>=d.$length)?$throwRuntimeError("index out of range"):d.$array[d.$offset+0]));c.buffer=$subslice(c.buffer,1);}return[a,b];};BD.prototype.Receive=function(){return this.$val.Receive();};BD.Ptr.prototype.ReceiveJSON=function(){var a=$ifaceNil,b=$ifaceNil,c,d,e,f;c=this;d=c.Receive();e=d[0];b=d[1];if(!($interfaceIsEqual(b,$ifaceNil))||e===$ifaceNil){return[a,b];}f=AA(BF(e));a=f[0];b=f[1];return[a,b];};BD.prototype.ReceiveJSON=function(){return this.$val.ReceiveJSON();};BD.Ptr.prototype.Close=function(){var a=$ifaceNil,$deferred=[],$err=null,b;try{$deferFrames.push($deferred);b=this;$deferred.push([(function(){a=R($recover());}),[]]);b.impl.close();a=b.error;return a;}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return a;}};BD.prototype.Close=function(){return this.$val.Close();};BF=$pkg.StringifyFrame=function(a){var b="",c,d,e,f;c=$assertType($internalize(a,$emptyInterface),$String,true);b=c[0];d=c[1];if(d){return b;}e=X(a);f=$assertType($internalize(e,$emptyInterface),($sliceType($Uint8)));b=$bytesToString(f);return b;};BG=$pkg.WebSocketTransport=function(a,b,$b){var $this=this,$args=arguments,c=false,d=false,$r,$deferred=[],$err=null,$s=0,e,f,g,h,i,j,k,l;if(!$b){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);s:while(true){switch($s){case 0:e=($ptrType(BD)).nil;$deferred.push([(function(){if(!(e===($ptrType(BD)).nil)){e.Close();}}),[true]]);f=BB(new AY(-1,4294967295));$deferred.push([$methodVal(f,"Stop"),[true]]);case 1:if(!(true)){$s=2;continue;}d=false;g=false;a.log(new($sliceType($emptyInterface))([new $String("connecting to"),new $String(b)]));e=BE("wss://"+b+"/v2/socket");f.Reset(P(new AY(0,9000),0.1));i=$select([[e.Notify],[f.C],[a.closeNotify]],true);$s=3;case 3:if(i&&i.$blocking){i=i();}h=i;if(h[0]===0){}else if(h[0]===1){$s=4;continue;}else if(h[0]===2){$s=5;continue;}else{$s=6;continue;}j=h[1][0];f.Stop();if(j){}else{$s=7;continue;}a.log(new($sliceType($emptyInterface))([new $String("connected")]));a.connState("connected");c=true;l=BH(a,e,true);$s=9;case 9:if(l&&l.$blocking){l=l();}k=l;d=k[0];g=k[1];$s=8;continue;case 7:a.log(new($sliceType($emptyInterface))([new $String("connection failed")]));case 8:$s=6;continue;case 4:a.log(new($sliceType($emptyInterface))([new $String("connection timeout")]));$s=6;continue;case 5:f.Stop();case 6:e.Close();e=($ptrType(BD)).nil;a.log(new($sliceType($emptyInterface))([new $String("disconnected")]));if(!d||!g||a.stopped){return[c,d];}$s=1;continue;case 2:case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);return[c,d];}};$f.$blocking=true;return $f;};BH=function(a,b,$b){var $this=this,$args=arguments,c=false,d=false,$r,$s=0,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s;if(!$b){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:e=$ifaceNil;if(a.sessionId===$ifaceNil){a.log(new($sliceType($emptyInterface))([new $String("session creation")]));e=a.makeCreateSessionAction();}else{a.log(new($sliceType($emptyInterface))([new $String("session resumption")]));e=a.makeResumeSessionAction(true);}f=b.SendJSON(e);if(!($interfaceIsEqual(f,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("send:"),f]));}if(a.sessionId===$ifaceNil){}else{$s=1;continue;}g=$ifaceNil;h=BB(P(new AY(0,13000),0.2));case 2:if(!(true)){$s=3;continue;}i=$ifaceNil;j=b.ReceiveJSON();g=j[0];i=j[1];if(!($interfaceIsEqual(i,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("session creation:"),i]));return[c,d];}if(!(g===$ifaceNil)){h.Stop();$s=3;continue;}l=$select([[b.Notify],[h.C]],true);$s=4;case 4:if(l&&l.$blocking){l=l();}k=l;if(k[0]===0){m=k[1][0];if(!m){a.log(new($sliceType($emptyInterface))([new $String("disconnected during session creation")]));h.Stop();return[c,d];}}else if(k[0]===1){a.log(new($sliceType($emptyInterface))([new $String("session creation timeout")]));return[c,d];}$s=2;continue;case 3:if(!a.handleSessionEvent(g)){return[c,d];}c=true;d=true;a.connActive();case 1:n=new($chanType($Bool,false,false))(1);o=new($chanType($Bool,false,false))(0);$go(BI,[a,b,n,o]);q=BJ(a,b,n,true);$s=5;case 5:if(q&&q.$blocking){q=q();}p=q;r=p[0];d=p[1];if(r){c=true;}s=$recv(o,true);$s=6;case 6:if(s&&s.$blocking){s=s();}s[0];return[c,d];case-1:}return;}};$f.$blocking=true;return $f;};BI=function(a,b,c,d,$b){var $this=this,$args=arguments,$r,$deferred=[],$err=null,$s=0,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,aa,ab,ac,ad,ae,af,ag,ah,ai,aj,ak,al;if(!$b){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);s:while(true){switch($s){case 0:$deferred.push([(function($b){var $this=this,$args=arguments,$r,$s=0;if(!$b){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:$r=$send(d,true,true);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[true]]);e=BB(P(new AY(0,56000),-0.3));$deferred.push([$methodVal(e,"Stop"),[true]]);a.numSent=0;case 1:if(!(true)){$s=2;continue;}case 3:if(!(a.numSent<a.sendBuffer.$length)){$s=4;continue;}h=(f=a.sendBuffer,g=a.numSent,((g<0||g>=f.$length)?$throwRuntimeError("index out of range"):f.$array[f.$offset+g]));if(!(h.Payload===$ifaceNil)){h.Header.frames=$parseInt(h.Payload.length);}if(!((i=a.receivedEventId,j=a.ackedEventId,(i.$high===j.$high&&i.$low===j.$low)))){h.Header.event_id=$externalize(a.receivedEventId,$Uint64);a.sendEventAck=false;a.ackedEventId=a.receivedEventId;}k=b.SendJSON(h.Header);delete h.Header[$externalize("frames",$String)];delete h.Header[$externalize("event_id",$String)];if(!($interfaceIsEqual(k,$ifaceNil))){}else{$s=5;continue;}a.log(new($sliceType($emptyInterface))([new $String("send:"),k]));$r=$send(c,true,true);$s=6;case 6:if($r&&$r.$blocking){$r=$r();}return;case 5:if(!(h.Payload===$ifaceNil)){}else{$s=7;continue;}l=0;case 8:if(!(l<$parseInt(h.Payload.length))){$s=9;continue;}m=h.Payload[l];if($internalize(h.Header.action,$String)==="update_user"){}else{$s=10;continue;}n=$assertType($internalize(m,$emptyInterface),$String,true);o=n[1];if(o){}else{$s=11;continue;}p=U(m);q=p[0];r=p[1];if(!($interfaceIsEqual(r,$ifaceNil))){}else{$s=12;continue;}a.log(new($sliceType($emptyInterface))([new $String("send:"),r]));$r=$send(c,true,true);$s=13;case 13:if($r&&$r.$blocking){$r=$r();}return;case 12:s=T(q);t=s[0];r=s[1];if(!($interfaceIsEqual(r,$ifaceNil))){}else{$s=14;continue;}a.log(new($sliceType($emptyInterface))([new $String("send:"),r]));$r=$send(c,true,true);$s=15;case 15:if($r&&$r.$blocking){$r=$r();}return;case 14:u=$parseInt(t.length);v=W(u);w=X(v);x=0;while(x<u){w[x]=t.charCodeAt(x);x=x+(1)>>0;}m=v;case 11:case 10:y=b.Send(m);if(!($interfaceIsEqual(y,$ifaceNil))){}else{$s=16;continue;}a.log(new($sliceType($emptyInterface))([new $String("send:"),y]));$r=$send(c,true,true);$s=17;case 17:if($r&&$r.$blocking){$r=$r();}return;case 16:l=l+(1)>>0;$s=8;continue;case 9:case 7:if((z=h.Id,(z.$high===0&&z.$low===0))){a.sendBuffer=$appendSlice($subslice(a.sendBuffer,0,a.numSent),$subslice(a.sendBuffer,(a.numSent+1>>0)));}else{a.numSent=a.numSent+(1)>>0;}e.Reset(P(new AY(0,56000),-0.3));$s=3;continue;case 4:if(a.sendEventAck&&!((aa=a.receivedEventId,ab=a.ackedEventId,(aa.$high===ab.$high&&aa.$low===ab.$low)))){}else{$s=18;continue;}ac=a.makeResumeSessionAction(false);ad=b.SendJSON(ac);if(!($interfaceIsEqual(ad,$ifaceNil))){}else{$s=19;continue;}a.log(new($sliceType($emptyInterface))([new $String("send:"),ad]));$r=$send(c,true,true);$s=20;case 20:if($r&&$r.$blocking){$r=$r();}return;case 19:case 18:af=$select([[a.sendNotify],[e.C],[c]],true);$s=21;case 21:if(af&&af.$blocking){af=af();}ae=af;if(ae[0]===0){}else if(ae[0]===1){$s=22;continue;}else if(ae[0]===2){$s=23;continue;}else{$s=24;continue;}ag=ae[1][0];if(!ag){ah=(ai=new $Map(),aj="action",ai[aj]={k:aj,v:new $String("close_session")},ai);ak=b.SendJSON(new($mapType($String,$emptyInterface))(ah));if(!($interfaceIsEqual(ak,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("send:"),ak]));}return;}$s=24;continue;case 22:al=b.Send(new($sliceType($Uint8))([]));if(!($interfaceIsEqual(al,$ifaceNil))){}else{$s=25;continue;}a.log(new($sliceType($emptyInterface))([new $String("send:"),al]));$r=$send(c,true,true);$s=26;case 26:if($r&&$r.$blocking){$r=$r();}return;case 25:e.Reset(P(new AY(0,56000),-0.3));$s=24;continue;case 23:return;case 24:$s=1;continue;case 2:case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);}};$f.$blocking=true;return $f;};BJ=function(a,b,c,$b){var $this=this,$args=arguments,d=false,e=false,$r,$deferred=[],$err=null,$s=0,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,aa,ab,ac;if(!$b){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);s:while(true){switch($s){case 0:f=$ifaceNil;g=$ifaceNil;h=0;i=BB(P(new AY(0,64000),0.3));$deferred.push([$methodVal(i,"Stop"),[true]]);j=BB(new AY(-1,4294967295));$deferred.push([$methodVal(j,"Stop"),[true]]);case 1:if(!(true)){$s=2;continue;}k=false;case 3:if(!(true)){$s=4;continue;}if(f===$ifaceNil){}else{$s=5;continue;}l=$ifaceNil;m=b.Receive();n=m[0];l=m[1];if(!($interfaceIsEqual(l,$ifaceNil))){}else{$s=7;continue;}a.log(new($sliceType($emptyInterface))([new $String("receive:"),l]));e=false;$r=$send(c,true,true);$s=8;case 8:if($r&&$r.$blocking){$r=$r();}return[d,e];case 7:if(n===$ifaceNil){$s=4;continue;}i.Reset(P(new AY(0,64000),0.7));a.connActive();o=BF(n);if(o.length===0){$s=3;continue;}p=AA(o);f=p[0];l=p[1];if(!($interfaceIsEqual(l,$ifaceNil))){}else{$s=9;continue;}a.log(new($sliceType($emptyInterface))([new $String("receive:"),l]));e=false;$r=$send(c,true,true);$s=10;case 10:if($r&&$r.$blocking){$r=$r();}return[d,e];case 9:g=V();q=H(f);h=q[0];l=q[1];if(!($interfaceIsEqual(l,$ifaceNil))){}else{$s=11;continue;}a.log(new($sliceType($emptyInterface))([new $String("receive:"),l]));e=false;$r=$send(c,true,true);$s=12;case 12:if($r&&$r.$blocking){$r=$r();}return[d,e];case 11:$s=6;continue;case 5:r=b.Receive();s=r[0];t=r[1];if(!($interfaceIsEqual(t,$ifaceNil))){}else{$s=13;continue;}a.log(new($sliceType($emptyInterface))([new $String("receive:"),t]));e=false;$r=$send(c,true,true);$s=14;case 14:if($r&&$r.$blocking){$r=$r();}return[d,e];case 13:if(s===$ifaceNil){$s=4;continue;}g.push(s);h=h-(1)>>0;case 6:if(h===0){}else{$s=15;continue;}u=a.handleEvent(f,g);v=u[1];w=u[2];if(!w){}else{$s=16;continue;}e=false;$r=$send(c,true,true);$s=17;case 17:if($r&&$r.$blocking){$r=$r();}return[d,e];case 16:if(v){k=true;}f=$ifaceNil;g=$ifaceNil;h=0;d=true;e=true;case 15:x=$select([[a.closeNotify],[c],[]]);if(x[0]===0){return[d,e];}else if(x[0]===1){return[d,e];}$s=3;continue;case 4:if(k&&!j.Active()){j.Reset(P(new AY(0,7000),-0.3));}z=$select([[b.Notify],[i.C],[j.C],[a.closeNotify],[c]],true);$s=18;case 18:if(z&&z.$blocking){z=z();}y=z;if(y[0]===0){}else if(y[0]===1){$s=19;continue;}else if(y[0]===2){$s=20;continue;}else if(y[0]===3){$s=21;continue;}else if(y[0]===4){$s=22;continue;}else{$s=23;continue;}aa=y[1][0];if(!aa){}else{$s=24;continue;}$r=$send(c,true,true);$s=25;case 25:if($r&&$r.$blocking){$r=$r();}return[d,e];case 24:$s=23;continue;case 19:a.log(new($sliceType($emptyInterface))([new $String("receive timeout")]));$r=$send(c,true,true);$s=26;case 26:if($r&&$r.$blocking){$r=$r();}return[d,e];$s=23;continue;case 20:if(!a.sendEventAck&&!((ab=a.ackedEventId,ac=a.receivedEventId,(ab.$high===ac.$high&&ab.$low===ac.$low)))){a.sendAck();}$s=23;continue;case 21:return[d,e];$s=23;continue;case 22:return[d,e];case 23:$s=1;continue;case 2:case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);return[d,e];}};$f.$blocking=true;return $f;};$pkg.$init=function(){$pkg.$init=function(){};var $r,$s=0;var $f=function(){while(true){switch($s){case 0:$r=A.$init(true);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}$r=B.$init(true);$s=2;case 2:if($r&&$r.$blocking){$r=$r();}$r=C.$init(true);$s=3;case 3:if($r&&$r.$blocking){$r=$r();}($ptrType(D)).methods=[["Name","Name","",$funcType([],[$String],false),-1]];D.init([["Id","Id","",$Uint64,""],["Header","Header","",B.Object,""],["Payload","Payload","",B.Object,""],["Deferred","Deferred","",($ptrType(AR)),""],["name","name","ninchatclient",$String,""]]);($ptrType(L)).methods=[["Failure","Failure","",$funcType([AY],[AY],false),-1],["Success","Success","",$funcType([],[],false),-1]];L.init([["lastSlot","lastSlot","ninchatclient",$Int,""]]);($ptrType(AR)).methods=[["Notify","Notify","",$funcType([($sliceType($emptyInterface))],[],true),-1],["Reject","Reject","",$funcType([($sliceType($emptyInterface))],[],true),-1],["Resolve","Resolve","",$funcType([($sliceType($emptyInterface))],[],true),-1],["then","then","ninchatclient",$funcType([B.Object,B.Object,B.Object],[],false),-1]];AR.init([["resolve","resolve","ninchatclient",($sliceType(B.Object)),""],["reject","reject","ninchatclient",($sliceType(B.Object)),""],["notify","notify","ninchatclient",($sliceType(B.Object)),""]]);AU.init([($ptrType(AV)),$String],[$Bool,$Bool],false);($ptrType(AV)).methods=[["Close","Close","",$funcType([],[],false),-1],["OnConnActive","OnConnActive","",$funcType([B.Object],[],false),-1],["OnConnState","OnConnState","",$funcType([B.Object],[],false),-1],["OnEvent","OnEvent","",$funcType([B.Object],[],false),-1],["OnLog","OnLog","",$funcType([B.Object],[],false),-1],["OnSessionEvent","OnSessionEvent","",$funcType([B.Object],[],false),-1],["Open","Open","",$funcType([],[],false),-1],["Send","Send","",$funcType([B.Object,B.Object],[$emptyInterface],false),-1],["SetAddress","SetAddress","",$funcType([B.Object],[],false),-1],["SetParams","SetParams","",$funcType([B.Object],[],false),-1],["SetTransport","SetTransport","",$funcType([B.Object],[],false),-1],["canLogin","canLogin","ninchatclient",$funcType([],[$Bool],false),-1],["connActive","connActive","ninchatclient",$funcType([],[],false),-1],["connState","connState","ninchatclient",$funcType([$String],[],false),-1],["connect","connect","ninchatclient",$funcType([AU,($sliceType($String)),($ptrType(L))],[$Bool],false),-1],["discover","discover","ninchatclient",$funcType([],[],false),-1],["handleEvent","handleEvent","ninchatclient",$funcType([B.Object,B.Object],[$Uint64,$Bool,$Bool],false),-1],["handleSessionEvent","handleSessionEvent","ninchatclient",$funcType([B.Object],[$Bool],false),-1],["log","log","ninchatclient",$funcType([($sliceType($emptyInterface))],[],true),-1],["makeCreateSessionAction","makeCreateSessionAction","ninchatclient",$funcType([],[B.Object],false),-1],["makeResumeSessionAction","makeResumeSessionAction","ninchatclient",$funcType([$Bool],[B.Object],false),-1],["send","send","ninchatclient",$funcType([($ptrType(D))],[],false),-1],["sendAck","sendAck","ninchatclient",$funcType([],[],false),-1]];AV.init([["onSessionEvent","onSessionEvent","ninchatclient",B.Object,""],["onEvent","onEvent","ninchatclient",B.Object,""],["onConnState","onConnState","ninchatclient",B.Object,""],["onConnActive","onConnActive","ninchatclient",B.Object,""],["onLog","onLog","ninchatclient",B.Object,""],["address","address","ninchatclient",$String,""],["forceLongPoll","forceLongPoll","ninchatclient",$Bool,""],["sessionParams","sessionParams","ninchatclient",B.Object,""],["sessionId","sessionId","ninchatclient",B.Object,""],["latestConnState","latestConnState","ninchatclient",$String,""],["latestConnActive","latestConnActive","ninchatclient",AX,""],["lastActionId","lastActionId","ninchatclient",$Uint64,""],["sendNotify","sendNotify","ninchatclient",($chanType($Bool,false,false)),""],["sendBuffer","sendBuffer","ninchatclient",($sliceType(($ptrType(D)))),""],["numSent","numSent","ninchatclient",$Int,""],["sendEventAck","sendEventAck","ninchatclient",$Bool,""],["receivedEventId","receivedEventId","ninchatclient",$Uint64,""],["ackedEventId","ackedEventId","ninchatclient",$Uint64,""],["closeNotify","closeNotify","ninchatclient",($chanType($Bool,false,false)),""],["closed","closed","ninchatclient",$Bool,""],["stopped","stopped","ninchatclient",$Bool,""]]);($ptrType(BA)).methods=[["Active","Active","",$funcType([],[$Bool],false),-1],["Reset","Reset","",$funcType([AY],[],false),-1],["Stop","Stop","",$funcType([],[],false),-1]];BA.init([["C","C","",($chanType($Bool,false,false)),""],["id","id","ninchatclient",B.Object,""]]);($ptrType(BD)).methods=[["Close","Close","",$funcType([],[$error],false),-1],["Receive","Receive","",$funcType([],[B.Object,$error],false),-1],["ReceiveJSON","ReceiveJSON","",$funcType([],[B.Object,$error],false),-1],["Send","Send","",$funcType([$emptyInterface],[$error],false),-1],["SendJSON","SendJSON","",$funcType([$emptyInterface],[$error],false),-1]];BD.init([["Notify","Notify","",($chanType($Bool,false,false)),""],["impl","impl","ninchatclient",B.Object,""],["open","open","ninchatclient",$Bool,""],["error","error","ninchatclient",$error,""],["buffer","buffer","ninchatclient",($sliceType(B.Object)),""]]);AF=0;AP=Y();AT=Q(new $Uint64(0,4096),-0.25);$pkg.WebSocketSupported=!($global.WebSocket===undefined);AQ();}return;}};$f.$blocking=true;return $f;};return $pkg;})();
