...
$packages["ninchatclient"]=(function(){var $pkg={},A=$packages["errors"],B=$packages["github.com/gopherjs/gopherjs/js"],C=$packages["sort"],D,L,AM,AN,AQ,AR,AT,AU,AW,AZ,AB,AK,AP,E,F,G,H,I,J,K,M,N,O,P,Q,R,S,T,U,V,W,X,Y,Z,AA,AC,AD,AE,AF,AG,AH,AI,AJ,AL,AO,AS,AV,AX,AY,BA,BB,BC,BD,BE,BF;D=$pkg.Action=$newType(0,"Struct","main.Action","Action","ninchatclient",function(Id_,Header_,Payload_,Resolve_,name_){this.$val=this;this.Id=Id_!==undefined?Id_:new $Uint64(0,0);this.Header=Header_!==undefined?Header_:$ifaceNil;this.Payload=Payload_!==undefined?Payload_:$ifaceNil;this.Resolve=Resolve_!==undefined?Resolve_:$throwNilPointerError;this.name=name_!==undefined?name_:"";});L=$pkg.Backoff=$newType(0,"Struct","main.Backoff","Backoff","ninchatclient",function(lastSlot_){this.$val=this;this.lastSlot=lastSlot_!==undefined?lastSlot_:0;});AM=$pkg.PromiseResolver=$newType(4,"Func","main.PromiseResolver","PromiseResolver","ninchatclient",null);AN=$pkg.Promise=$newType(0,"Struct","main.Promise","Promise","ninchatclient",function(settled_,successful_,args_,successCallbacks_,failureCallbacks_){this.$val=this;this.settled=settled_!==undefined?settled_:false;this.successful=successful_!==undefined?successful_:false;this.args=args_!==undefined?args_:($sliceType($emptyInterface)).nil;this.successCallbacks=successCallbacks_!==undefined?successCallbacks_:($sliceType(B.Object)).nil;this.failureCallbacks=failureCallbacks_!==undefined?failureCallbacks_:($sliceType(B.Object)).nil;});AQ=$pkg.Transport=$newType(4,"Func","main.Transport","Transport","ninchatclient",null);AR=$pkg.Session=$newType(0,"Struct","main.Session","Session","ninchatclient",function(onSessionEvent_,onEvent_,onConnState_,onConnActive_,onLog_,address_,forceLongPoll_,sessionParams_,sessionId_,binarySupported_,latestConnState_,latestConnActive_,lastActionId_,sendNotify_,sendBuffer_,numSent_,sendEventAck_,receivedEventId_,ackedEventId_,closeNotify_,closed_){this.$val=this;this.onSessionEvent=onSessionEvent_!==undefined?onSessionEvent_:$ifaceNil;this.onEvent=onEvent_!==undefined?onEvent_:$ifaceNil;this.onConnState=onConnState_!==undefined?onConnState_:$ifaceNil;this.onConnActive=onConnActive_!==undefined?onConnActive_:$ifaceNil;this.onLog=onLog_!==undefined?onLog_:$ifaceNil;this.address=address_!==undefined?address_:"";this.forceLongPoll=forceLongPoll_!==undefined?forceLongPoll_:false;this.sessionParams=sessionParams_!==undefined?sessionParams_:$ifaceNil;this.sessionId=sessionId_!==undefined?sessionId_:$ifaceNil;this.binarySupported=binarySupported_!==undefined?binarySupported_:false;this.latestConnState=latestConnState_!==undefined?latestConnState_:"";this.latestConnActive=latestConnActive_!==undefined?latestConnActive_:new AT(0,0);this.lastActionId=lastActionId_!==undefined?lastActionId_:new $Uint64(0,0);this.sendNotify=sendNotify_!==undefined?sendNotify_:($chanType($Bool,false,false)).nil;this.sendBuffer=sendBuffer_!==undefined?sendBuffer_:($sliceType(($ptrType(D)))).nil;this.numSent=numSent_!==undefined?numSent_:0;this.sendEventAck=sendEventAck_!==undefined?sendEventAck_:false;this.receivedEventId=receivedEventId_!==undefined?receivedEventId_:new $Uint64(0,0);this.ackedEventId=ackedEventId_!==undefined?ackedEventId_:new $Uint64(0,0);this.closeNotify=closeNotify_!==undefined?closeNotify_:($chanType($Bool,false,false)).nil;this.closed=closed_!==undefined?closed_:false;});AT=$pkg.Time=$newType(8,"Int64","main.Time","Time","ninchatclient",null);AU=$pkg.Duration=$newType(8,"Int64","main.Duration","Duration","ninchatclient",null);AW=$pkg.Timer=$newType(0,"Struct","main.Timer","Timer","ninchatclient",function(C_,id_){this.$val=this;this.C=C_!==undefined?C_:($chanType($Bool,false,false)).nil;this.id=id_!==undefined?id_:$ifaceNil;});AZ=$pkg.WebSocket=$newType(0,"Struct","main.WebSocket","WebSocket","ninchatclient",function(Notify_,impl_,buffer_){this.$val=this;this.Notify=Notify_!==undefined?Notify_:($chanType($Bool,false,false)).nil;this.impl=impl_!==undefined?impl_:$ifaceNil;this.buffer=buffer_!==undefined?buffer_:($sliceType(B.Object)).nil;});D.Ptr.prototype.Name=function(){var a;a=this;if(a.name===""){a.name=$internalize(a.Header.action,$String);}return a.name;};D.prototype.Name=function(){return this.$val.Name();};E=$pkg.GetAddress=function(a){if((a===undefined)||(a===null)){return"api.ninchat.com";}else{return $internalize(a,$String);}};F=$pkg.GetEndpointHosts=function(a){var b=($sliceType($String)).nil,c=$ifaceNil,$deferred=[],$err=null,d,e;try{$deferFrames.push($deferred);$deferred.push([(function(){var d;d=Q($recover());if(!($interfaceIsEqual(d,$ifaceNil))){c=d;}}),[]]);d=a.hosts;if($parseInt(d.length)===0){c=A.New("endpoint hosts array is empty");return[b,c];}b=($sliceType($String)).make($parseInt(d.length));e=0;while(e<$parseInt(d.length)){(e<0||e>=b.$length)?$throwRuntimeError("index out of range"):b.$array[b.$offset+e]=$internalize(d[e],$String);e=e+(1)>>0;}return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};G=$pkg.GetSessionEventCredentials=function(a){var b=$ifaceNil,c=$ifaceNil,d=$ifaceNil,e=new $Uint64(0,0),f=false,g=$ifaceNil,$deferred=[],$err=null,h;try{$deferFrames.push($deferred);$deferred.push([(function(){var h;h=Q($recover());if(!($interfaceIsEqual(h,$ifaceNil))){g=h;}}),[]]);if(!($internalize(a.event,$String)==="session_created")){return[b,c,d,e,f,g];}b=a.user_id;h=a.user_auth;if(!(h===undefined)){c=h;}d=a.session_id;e=$internalize(a.event_id,$Uint64);f=true;return[b,c,d,e,f,g];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c,d,e,f,g];}};H=$pkg.GetEventFrames=function(a){var b=0,c=$ifaceNil,$deferred=[],$err=null,d;try{$deferFrames.push($deferred);$deferred.push([(function(){c=Q($recover());}),[]]);d=a.frames;if(!(d===undefined)){b=$parseInt(d)>>0;if(b<0){b=0;}}return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};I=$pkg.GetEventAndActionId=function(a){var b=new $Uint64(0,0),c=new $Uint64(0,0),d=$ifaceNil,$deferred=[],$err=null,e,f;try{$deferFrames.push($deferred);$deferred.push([(function(){d=Q($recover());}),[]]);e=a.event_id;if(!(e===undefined)){b=$internalize(e,$Uint64);}f=a.action_id;if(!(f===undefined)){c=$internalize(f,$Uint64);}return[b,c,d];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c,d];}};J=$pkg.IsEventLastReply=function(a,b){var c=false,d=$ifaceNil,$deferred=[],$err=null,e,f,g,h;try{$deferFrames.push($deferred);$deferred.push([(function(){d=Q($recover());}),[]]);e=b.name;if(e==="load_history"){f=$parseInt(a.history_length)>>0;c=(f===0);}else if(e==="search"){g=a.users;h=a.channels;c=(g===undefined)&&(h===undefined);}else{c=true;}return[c,d];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[c,d];}};K=$pkg.GetEventError=function(a){var b="",c="",d=false,e=$ifaceNil,$deferred=[],$err=null,f,g;try{$deferFrames.push($deferred);$deferred.push([(function(){var f;f=Q($recover());if(!($interfaceIsEqual(f,$ifaceNil))){e=f;}}),[]]);if(!($internalize(a.event,$String)==="error")){return[b,c,d,e];}b=$internalize(a.error_type,$String);f=a.error_reason;if(!(f===undefined)){c=$internalize(f,$String);}g=b;if(g==="session_not_found"){d=true;if(!(c==="")){e=A.New("error: "+b+" ("+c+")");}else{e=A.New("error: "+b);}}else if(g==="connection_superseded"||g==="message_has_too_many_parts"||g==="message_part_too_long"||g==="message_too_long"||g==="request_malformed"){if(!(c==="")){e=A.New("error: "+b+" ("+c+")");}else{e=A.New("error: "+b);}}return[b,c,d,e];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c,d,e];}};L.Ptr.prototype.Success=function(){var a;a=this;a.lastSlot=0;};L.prototype.Success=function(){return this.$val.Success();};L.Ptr.prototype.Failure=function(a){var b=new AU(0,0),c;c=this;if(c.lastSlot>0){b=new AU(0,N($flatten64(a)*c.lastSlot/1024,-0.5));}if(c.lastSlot<1023){c.lastSlot=((((c.lastSlot+1>>0))<<1>>0))-1>>0;}return b;};L.prototype.Failure=function(a){return this.$val.Failure(a);};M=$pkg.Call=function(a,b,c){var d=$ifaceNil,e,f,g;e="https://"+E(c)+"/v2/call";f=AO();d=f[0];g=f[1];$go((function($b){var $this=this,$args=arguments,$r,$s=0,h,i,j,k,l;if(!$b){$nonblockingCall();};var $f=function(){while(true){switch($s){case 0:h=AD(e,a,O(new AU(0,11000),0.1));i=h[0];j=h[1];if(!($interfaceIsEqual(j,$ifaceNil))){AF("NinchatClient.call onLog callback",b,new($sliceType($emptyInterface))([new $String("call:"),j]));g(false,new($sliceType($emptyInterface))([]));return;}k=$recv(i,true);$s=1;case 1:if(k&&k.$blocking){k=k();}l=k[0];if(!(l===$ifaceNil)){}else{$s=2;continue;}g(true,new($sliceType($emptyInterface))([l]));$s=3;continue;case 2:g(false,new($sliceType($emptyInterface))([]));case 3:case-1:}return;}};$f.$blocking=true;return $f;}),[]);return d;};N=$pkg.Jitter=function(a,b){return a+a*b*Y();};O=$pkg.JitterDuration=function(a,b){return new AU(0,N($flatten64(a),b));};P=$pkg.JitterUint64=function(a,b){return new $Uint64(0,N($flatten64(a),b));};Q=function(a){var b=$ifaceNil,c,d,e;if($interfaceIsEqual(a,$ifaceNil)){return b;}c=$assertType(a,($ptrType(B.Error)),true);d=c[0];e=c[1];if(e){b=A.New($internalize(d.Object.message,$String));return b;}b=$assertType(a,$error);return b;};R=function(a,b,c){var d=false,$deferred=[],$err=null;try{$deferFrames.push($deferred);$deferred.push([(function(){var e;e=Q($recover());if(!($interfaceIsEqual(e,$ifaceNil))){console.log(a+" invocation error: "+e.Error());}}),[]]);b.apply(undefined,$externalize(c,($sliceType($emptyInterface))));d=true;return d;}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return d;}};S=$pkg.NewArray=function(){return new($global.Array)();};T=$pkg.NewUint8Array=function(a){return new($global.Uint8Array)(a);};U=$pkg.NewObject=function(){return new($global.Object)();};V=$pkg.EncodeURIComponent=function(a){return $internalize($global.encodeURIComponent($externalize(a,$String)),$String);};W=$pkg.ParseJSON=function(a){var b=$ifaceNil,c=$ifaceNil,$deferred=[],$err=null;try{$deferFrames.push($deferred);$deferred.push([(function(){c=Q($recover());}),[]]);b=$global.JSON.parse($externalize(a,$String));return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};X=$pkg.StringifyJSON=function(a){var b="",c=$ifaceNil,$deferred=[],$err=null;try{$deferFrames.push($deferred);$deferred.push([(function(){c=Q($recover());}),[]]);b=$internalize($global.JSON.stringify($externalize(a,$emptyInterface)),$String);return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};Y=$pkg.Random=function(){return $parseFloat($global.Math.random());};Z=$pkg.SetTimeout=function(a,b){var c=$ifaceNil;c=$global.setTimeout($externalize(a,($funcType([],[],false))),$externalize(b,AU));return c;};AA=$pkg.ClearTimeout=function(a){$global.clearTimeout(a);};AC=$pkg.JSONP=function(a,b){var c=($chanType(B.Object,false,false)).nil,d=$ifaceNil,e;e=AE(a+"?callback=",b);c=e[0];d=e[1];return[c,d];};AD=$pkg.DataJSONP=function(a,b,c){var d=($chanType(B.Object,false,false)).nil,e=$ifaceNil,f,g,h;f=X(b);g=f[0];e=f[1];if(!($interfaceIsEqual(e,$ifaceNil))){return[d,e];}h=AE(a+"?data="+V(g)+"&callback=",c);d=h[0];e=h[1];return[d,e];};AE=function(a,b){var c=($chanType(B.Object,false,false)).nil,d=$ifaceNil,$deferred=[],$err=null,e,f,g,h,i,j,k,l;try{$deferFrames.push($deferred);$deferred.push([(function(){d=Q($recover());}),[]]);e=X(new $Int(AB));f=e[0];AB=((AB+1>>0))&2147483647;g="_callback"+f;h="NinchatClient."+g;c=new($chanType(B.Object,false,false))(1);i=Z((function(){AK[$externalize(g,$String)]=$externalize((function(){delete AK[$externalize(g,$String)];}),($funcType([B.Object],[],false)));$go((function(){$close(c);}),[]);}),b);AK[$externalize(g,$String)]=$externalize((function(j){AA(i);delete AK[$externalize(g,$String)];$go((function($b){var $this=this,$args=arguments,$r,$s=0;if(!$b){$nonblockingCall();};var $f=function(){while(true){switch($s){case 0:$r=$send(c,j,true);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[]);}),($funcType([B.Object],[],false)));j=$global.document;k=j.createElement($externalize("script",$String));k.type=$externalize("text/javascript",$String);k.async=$externalize(true,$Bool);k.src=$externalize(a+h,$String);l=j.getElementsByTagName($externalize("head",$String))[0];l.appendChild(k);return[c,d];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[c,d];}};AF=$pkg.Log=function(a,b,c){var d,e,f,g,h,i,j,k,l,m,n;if(b===$ifaceNil||(b===undefined)||(b===null)){return;}d="";e=c;f=0;while(f<e.$length){g=((f<0||f>=e.$length)?$throwRuntimeError("index out of range"):e.$array[e.$offset+f]);h="?";i=$assertType(g,$String,true);j=i[0];k=i[1];if(k){h=j;}else{l=$assertType(g,$error,true);m=l[0];n=l[1];if(n){h=m.Error();}}if(d.length>0){d=d+(" ");}d=d+(h);f++;}while(d.length>0&&(d.charCodeAt((d.length-1>>0))===32)){d=d.substring(0,(d.length-1>>0));}R(a,b,new($sliceType($emptyInterface))([new $String(d)]));};AG=$pkg.LongPollTransport=function(a,b,$b){var $this=this,$args=arguments,c=false,d=false,$r,$deferred=[],$err=null,$s=0,e,f,g,h,i,j,k,l,m,n,o;if(!$b){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);while(true){switch($s){case 0:$deferred.push([(function(){var e;e=Q($recover());if(!($interfaceIsEqual(e,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("poll:"),e]));}}),[true]]);c=true;e="https://"+b+"/v2/poll";if(a.sessionId===$ifaceNil){}else{$s=1;continue;}a.log(new($sliceType($emptyInterface))([new $String("session creation")]));f=a.makeCreateSessionAction();g=AD(e,f,O(new AU(0,13000),0.2));h=g[0];i=g[1];if(!($interfaceIsEqual(i,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("session creation:"),i]));return[c,d];}k=$select([[h],[a.closeNotify]],true);$s=3;case 3:if(k&&k.$blocking){k=k();}j=k;if(j[0]===0){l=j[1][0];if(l===$ifaceNil){a.log(new($sliceType($emptyInterface))([new $String("session creation timeout")]));return[c,d];}m=l[0];if(!a.handleSessionEvent(m)){return[c,d];}}else if(j[0]===1){AJ(a,e);return[c,d];}d=true;a.connState("connected");a.connActive();$s=2;continue;case 1:a.log(new($sliceType($emptyInterface))([new $String("session resumption")]));n=AI(a,e);if(!($interfaceIsEqual(n,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("session resumption:"),n]));return[c,d];}case 2:o=AH(a,e,true);$s=4;case 4:if(o&&o.$blocking){o=o();}if(o){}else{$s=5;continue;}d=true;case 5:return[c,d];case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);return[c,d];}};$f.$blocking=true;return $f;};AH=function(a,b,$b){var $this=this,$args=arguments,c=false,$r,$s=0,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z,aa,ab,ac,ad,ae,af,ag,ah,ai;if(!$b){$nonblockingCall();};var $f=function(){while(true){switch($s){case 0:a.binarySupported=false;d=($chanType(B.Object,false,true)).nil;e=($chanType(B.Object,false,true)).nil;f=new $Uint64(0,0);g=0;case 1:if(!(g<2)){$s=2;continue;}if(d===($chanType(B.Object,false,true)).nil){h=$ifaceNil;i=a.makeResumeSessionAction(true);j=AD(b,i,O(new AU(0,64000),0.2));d=j[0];h=j[1];if(!($interfaceIsEqual(h,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("poll:"),h]));return c;}}if(e===($chanType(B.Object,false,true)).nil&&a.numSent<a.sendBuffer.$length){m=(k=a.sendBuffer,l=a.numSent,((l<0||l>=k.$length)?$throwRuntimeError("index out of range"):k.$array[k.$offset+l]));if(!(m.Payload===$ifaceNil)){n=$internalize(m.Payload[0],$String);o=W(n);p=o[0];q=o[1];if(!($interfaceIsEqual(q,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("send:"),q]));return c;}m.Header.payload=p;}m.Header.session_id=a.sessionId;r=AD(b,m.Header,O(new AU(0,7000),0.2));s=r[0];t=r[1];delete m.Header[$externalize("payload",$String)];delete m.Header[$externalize("session_id",$String)];if(!($interfaceIsEqual(t,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("send:"),t]));return c;}if((u=m.Id,(u.$high===0&&u.$low===0))){a.sendBuffer=$appendSlice($subslice(a.sendBuffer,0,a.numSent),$subslice(a.sendBuffer,(a.numSent+1>>0)));}else{e=s;f=m.Id;}}v=$ifaceNil;x=$select([[d],[e],[a.sendNotify],[a.closeNotify]],true);$s=3;case 3:if(x&&x.$blocking){x=x();}w=x;if(w[0]===0){v=w[1][0];if(v===$ifaceNil){a.log(new($sliceType($emptyInterface))([new $String("poll timeout")]));}d=($chanType(B.Object,false,true)).nil;a.connActive();}else if(w[0]===1){v=w[1][0];if(v===$ifaceNil){a.log(new($sliceType($emptyInterface))([new $String("send timeout")]));}else if((f.$high>0||(f.$high===0&&f.$low>0))){a.numSent=a.numSent+(1)>>0;}e=($chanType(B.Object,false,true)).nil;f=new $Uint64(0,0);}else if(w[0]===2){y=w[1][0];if(!y){AJ(a,b);return c;}$s=1;continue;}else if(w[0]===3){AJ(a,b);return c;}if(v===$ifaceNil){g=g+(1)>>0;$s=1;continue;}g=0;z=0;while(z<$parseInt(v.length)){aa=v[z];ab=S();ac=aa.payload;if(!(ac===undefined)){ad=X(ac);ae=ad[0];af=ad[1];if(!($interfaceIsEqual(af,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("poll payload:"),af]));return c;}ab.push($externalize(ae,$String));}ag=a.handleEvent(aa,ab);ah=ag[0];ai=ag[2];if((f.$high>0||(f.$high===0&&f.$low>0))&&(f.$high<ah.$high||(f.$high===ah.$high&&f.$low<=ah.$low))){f=new $Uint64(0,0);a.numSent=a.numSent+(1)>>0;}if(!ai){return c;}if(!c){c=true;a.connState("connected");}z=z+(1)>>0;}$s=1;continue;case 2:return c;case-1:}return;}};$f.$blocking=true;return $f;};AI=function(a,b){var c=$ifaceNil,d,e,f,g;d=(e=new $Map(),f="action",e[f]={k:f,v:new $String("ping")},f="session_id",e[f]={k:f,v:a.sessionId},e);g=AD(b,new($mapType($String,$emptyInterface))(d),O(new AU(0,7000),0.9));c=g[1];return c;};AJ=function(a,b){var c,d,e,f,g;c=(d=new $Map(),e="action",d[e]={k:e,v:new $String("close_session")},e="session_id",d[e]={k:e,v:a.sessionId},d);f=AD(b,new($mapType($String,$emptyInterface))(c),O(new AU(0,7000),0.9));g=f[1];if(!($interfaceIsEqual(g,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("send:"),g]));}};AL=function(){AK.call=$externalize(M,($funcType([B.Object,B.Object,B.Object],[B.Object],false)));AK.newSession=$externalize(AS,($funcType([],[($mapType($String,$emptyInterface))],false)));AK.stringifyFrame=$externalize(BB,($funcType([B.Object],[$String],false)));$global.NinchatClient=AK;};AO=$pkg.NewPromise=function(){var a=$ifaceNil,b=$throwNilPointerError,c;c=new AN.Ptr();$copy(c,new AN.Ptr(),AN);a=U();a.then=$externalize($methodVal(c,"Then"),($funcType([B.Object,B.Object],[],false)));b=$methodVal(c,"Resolve");return[a,b];};AN.Ptr.prototype.Then=function(a,b){var c,d,e;c=this;d=!(a===undefined)&&!(a===null);e=!(b===undefined)&&!(b===null);if(c.settled){if(c.successful){if(d){R("NinchatClient promise success callback",a,c.args);}}else{if(e){R("NinchatClient promise failure callback",b,c.args);}}}else{if(d){c.successCallbacks=$append(c.successCallbacks,a);}if(e){c.failureCallbacks=$append(c.failureCallbacks,b);}}};AN.prototype.Then=function(a,b){return this.$val.Then(a,b);};AN.Ptr.prototype.Resolve=function(a,b){var c,d,e,f,g,h,i;c=this;if(c.settled){$panic(new $String("promise has already been settled"));}c.settled=true;c.successful=a;c.args=b;if(a){d=c.successCallbacks;e=0;while(e<d.$length){f=((e<0||e>=d.$length)?$throwRuntimeError("index out of range"):d.$array[d.$offset+e]);R("NinchatClient promise success callback",f,c.args);e++;}}else{g=c.failureCallbacks;h=0;while(h<g.$length){i=((h<0||h>=g.$length)?$throwRuntimeError("index out of range"):g.$array[g.$offset+h]);R("NinchatClient promise failure callback",i,c.args);h++;}}};AN.prototype.Resolve=function(a,b){return this.$val.Resolve(a,b);};AS=$pkg.NewSession=function(){var a,b,c;a=new AR.Ptr($ifaceNil,$ifaceNil,$ifaceNil,$ifaceNil,$ifaceNil,"api.ninchat.com",false,$ifaceNil,$ifaceNil,false,"",new AT(0,0),new $Uint64(0,0),($chanType($Bool,false,false)).nil,($sliceType(($ptrType(D)))).nil,0,false,new $Uint64(0,0),new $Uint64(0,0),($chanType($Bool,false,false)).nil,true);return(b=new $Map(),c="onSessionEvent",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"OnSessionEvent"))},c="onEvent",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"OnEvent"))},c="onConnState",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"OnConnState"))},c="onConnActive",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"OnConnActive"))},c="onLog",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"OnLog"))},c="setParams",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"SetParams"))},c="setTransport",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"SetTransport"))},c="setAddress",b[c]={k:c,v:new($funcType([B.Object],[],false))($methodVal(a,"SetAddress"))},c="open",b[c]={k:c,v:new($funcType([],[],false))($methodVal(a,"Open"))},c="close",b[c]={k:c,v:new($funcType([],[],false))($methodVal(a,"Close"))},c="binarySupported",b[c]={k:c,v:new($funcType([],[$Bool],false))($methodVal(a,"BinarySupported"))},c="send",b[c]={k:c,v:new($funcType([B.Object,B.Object],[B.Object],false))($methodVal(a,"Send"))},b);};AR.Ptr.prototype.OnSessionEvent=function(a){var b;b=this;b.onSessionEvent=a;};AR.prototype.OnSessionEvent=function(a){return this.$val.OnSessionEvent(a);};AR.Ptr.prototype.OnEvent=function(a){var b;b=this;b.onEvent=a;};AR.prototype.OnEvent=function(a){return this.$val.OnEvent(a);};AR.Ptr.prototype.OnConnState=function(a){var b;b=this;if(a===null){a=$ifaceNil;}b.onConnState=a;if(!(b.onConnState===$ifaceNil)&&!(b.latestConnState==="")){R("NinchatClient.Session onConnState callback",b.onConnState,new($sliceType($emptyInterface))([new $String(b.latestConnState)]));}};AR.prototype.OnConnState=function(a){return this.$val.OnConnState(a);};AR.Ptr.prototype.OnConnActive=function(a){var b,c;b=this;if(a===null){a=$ifaceNil;}b.onConnActive=a;if(!(b.onConnActive===$ifaceNil)&&(c=b.latestConnActive,(c.$high>0||(c.$high===0&&c.$low>0)))){R("NinchatClient.Session onConnActive callback",b.onConnActive,new($sliceType($emptyInterface))([b.latestConnActive]));}};AR.prototype.OnConnActive=function(a){return this.$val.OnConnActive(a);};AR.Ptr.prototype.OnLog=function(a){var b;b=this;if(a===null){a=$ifaceNil;}b.onLog=a;};AR.prototype.OnLog=function(a){return this.$val.OnLog(a);};AR.Ptr.prototype.SetParams=function(a){var b,c;b=this;if(a.message_types===undefined){$panic(new $String("message_types parameter not defined"));}c=a.session_id;if(!(c===undefined)&&!(c===null)){b.sessionId=c;}delete a[$externalize("session_id",$String)];b.sessionParams=a;};AR.prototype.SetParams=function(a){return this.$val.SetParams(a);};AR.Ptr.prototype.SetTransport=function(a){var b,c,d;b=this;if(a===null){b.forceLongPoll=false;return;}c=$internalize(a,$String);d=c;if(d==="websocket"){$panic(new $String("websocket transport cannot be forced"));}else if(d==="longpoll"){b.forceLongPoll=true;}else{$panic(new $String("unknown transport: "+c));}};AR.prototype.SetTransport=function(a){return this.$val.SetTransport(a);};AR.Ptr.prototype.SetAddress=function(a){var b;b=this;b.address=E(a);};AR.prototype.SetAddress=function(a){return this.$val.SetAddress(a);};AR.Ptr.prototype.Open=function(){var a;a=this;if(!(a.sendNotify===($chanType($Bool,false,false)).nil)){$panic(new $String("session already initialized"));}if(a.onSessionEvent===$ifaceNil){$panic(new $String("onSessionEvent callback not defined"));}if(a.onEvent===$ifaceNil){$panic(new $String("onEvent callback not defined"));}if(a.sessionParams===$ifaceNil){$panic(new $String("session parameters not defined"));}a.sendNotify=new($chanType($Bool,false,false))(1);a.closeNotify=new($chanType($Bool,false,false))(1);a.closed=false;$go($methodVal(a,"discover"),[]);};AR.prototype.Open=function(){return this.$val.Open();};AR.Ptr.prototype.Close=function(){var a,b,c,d;a=this;if(a.closed){return;}b=a.sendBuffer;c=0;while(c<b.$length){d=((c<0||c>=b.$length)?$throwRuntimeError("index out of range"):b.$array[b.$offset+c]);a.resolve(d,false,new($sliceType($emptyInterface))([]));c++;}a.sendBuffer=($sliceType(($ptrType(D)))).nil;a.numSent=0;a.closed=true;$go((function($b){var $this=this,$args=arguments,$r,$s=0;if(!$b){$nonblockingCall();};var $f=function(){while(true){switch($s){case 0:$r=$send(a.closeNotify,true,true);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}$close(a.sendNotify);case-1:}return;}};$f.$blocking=true;return $f;}),[]);};AR.prototype.Close=function(){return this.$val.Close();};AR.Ptr.prototype.BinarySupported=function(){var a;a=this;return a.binarySupported;};AR.prototype.BinarySupported=function(){return this.$val.BinarySupported();};AR.Ptr.prototype.Send=function(a,b){var c=$ifaceNil,d,e,f,g,h;d=this;if(d.sendNotify===($chanType($Bool,false,false)).nil){$panic(new $String("session not initialized"));}if(d.closed){$panic(new $String("session already closed"));}if((b===undefined)||(b===null)||($parseInt(b.length)===0)){b=$ifaceNil;}e=new D.Ptr(new $Uint64(0,0),a,b,$throwNilPointerError,"");if(a.action_id===null){delete a[$externalize("action_id",$String)];}else{d.lastActionId=(f=d.lastActionId,g=new $Uint64(0,1),new $Uint64(f.$high+g.$high,f.$low+g.$low));e.Id=d.lastActionId;a.action_id=$externalize(e.Id,$Uint64);h=AO();c=h[0];e.Resolve=h[1];}d.send(e);return c;};AR.prototype.Send=function(a,b){return this.$val.Send(a,b);};AR.Ptr.prototype.send=function(a){var b;b=this;b.sendBuffer=$append(b.sendBuffer,a);$go((function(){var c;c=$select([[b.sendNotify,true],[]]);}),[]);return;};AR.prototype.send=function(a){return this.$val.send(a);};AR.Ptr.prototype.sendAck=function(){var a;a=this;a.sendEventAck=true;$go((function(){var b;b=$select([[a.sendNotify,true],[]]);}),[]);};AR.prototype.sendAck=function(){return this.$val.sendAck();};AR.Ptr.prototype.reset=function(){var a;a=this;a.sessionId=$ifaceNil;if(a.sendBuffer.$length===0){a.lastActionId=new $Uint64(0,0);}a.numSent=0;a.sendEventAck=false;a.receivedEventId=new $Uint64(0,0);a.ackedEventId=new $Uint64(0,0);};AR.prototype.reset=function(){return this.$val.reset();};AR.Ptr.prototype.discover=function($b){var $this=this,$args=arguments,$r,$deferred=[],$err=null,$s=0,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p;if(!$b){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);while(true){switch($s){case 0:a=$this;a.log(new($sliceType($emptyInterface))([new $String("opening")]));$deferred.push([$methodVal(a,"log"),[new($sliceType($emptyInterface))([new $String("closed")]),true]]);$deferred.push([$methodVal(a,"connState"),["disconnected",true]]);b=new L.Ptr();$copy(b,new L.Ptr(),L);c=false;case 1:if(!(!a.closed)){$s=2;continue;}a.log(new($sliceType($emptyInterface))([new $String("endpoint discovery")]));a.connState("connecting");d="https://"+a.address+"/v2/endpoint";e=AC(d,O(new AU(0,7000),0.1));f=e[0];g=e[1];if(!($interfaceIsEqual(g,$ifaceNil))){}else{$s=3;continue;}a.log(new($sliceType($emptyInterface))([new $String("endpoint discovery:"),g]));$s=4;continue;case 3:i=$select([[f],[a.closeNotify]],true);$s=5;case 5:if(i&&i.$blocking){i=i();}h=i;if(h[0]===0){}else if(h[0]===1){$s=6;continue;}else{$s=7;continue;}j=h[1][0];if(j===$ifaceNil){}else{$s=8;continue;}a.log(new($sliceType($emptyInterface))([new $String("endpoint discovery timed out")]));$s=9;continue;case 8:k=F(j);l=k[0];m=k[1];if(!($interfaceIsEqual(m,$ifaceNil))){}else{$s=10;continue;}a.log(new($sliceType($emptyInterface))([new $String("endpoint discovery:"),m]));$s=11;continue;case 10:a.log(new($sliceType($emptyInterface))([new $String("endpoint discovered")]));if(!$pkg.WebSocketSupported||a.forceLongPoll||c){}else{$s=12;continue;}n=a.connect(AG,l,b,true);$s=14;case 14:if(n&&n.$blocking){n=n();}n;$s=13;continue;case 12:o=a.connect(BC,l,b,true);$s=15;case 15:if(o&&o.$blocking){o=o();}c=!o;case 13:$s=1;continue;case 11:case 9:$s=7;continue;case 6:return;case 7:case 4:p=b.Failure(new AU(0,60000));if((p.$high>0||(p.$high===0&&p.$low>0))){}else{$s=16;continue;}a.log(new($sliceType($emptyInterface))([new $String("sleeping")]));a.connState("disconnected");$r=AY(p,true);$s=17;case 17:if($r&&$r.$blocking){$r=$r();}case 16:$s=1;continue;case 2:case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);}};$f.$blocking=true;return $f;};AR.prototype.discover=function($b){return this.$val.discover($b);};AR.Ptr.prototype.connect=function(a,b,c,$b){var $this=this,$args=arguments,d=false,$r,$s=0,e,f,g,h,i,j,k,l,m,n;if(!$b){$nonblockingCall();};var $f=function(){while(true){switch($s){case 0:e=$this;f=0;case 1:if(!(f<2)){$s=2;continue;}g=b;h=0;case 3:if(!(h<g.$length)){$s=4;continue;}i=((h<0||h>=g.$length)?$throwRuntimeError("index out of range"):g.$array[g.$offset+h]);e.connState("connecting");k=a(e,i,true);$s=5;case 5:if(k&&k.$blocking){k=k();}j=k;l=j[0];m=j[1];if(l){d=true;}if(m){c.Success();return d;}if(e.closed){return d;}n=c.Failure(new AU(0,60000));if((n.$high>0||(n.$high===0&&n.$low>0))){}else{$s=6;continue;}e.log(new($sliceType($emptyInterface))([new $String("sleeping")]));e.connState("disconnected");$r=AY(n,true);$s=7;case 7:if($r&&$r.$blocking){$r=$r();}case 6:h++;$s=3;continue;case 4:f=f+(1)>>0;$s=1;continue;case 2:return d;case-1:}return;}};$f.$blocking=true;return $f;};AR.prototype.connect=function(a,b,c,$b){return this.$val.connect(a,b,c,$b);};AR.Ptr.prototype.canLogin=function(){var a,b,c,d,e,f,g,h,i,j,k;a=this;b=a.sessionParams.access_key;if(!(b===undefined)&&!(b===null)){return true;}c=a.sessionParams.user_id;if(!(c===undefined)&&!(c===null)){d=new($sliceType($String))(["user_auth","master_sign"]);e=0;while(e<d.$length){f=((e<0||e>=d.$length)?$throwRuntimeError("index out of range"):d.$array[d.$offset+e]);g=a.sessionParams[$externalize(f,$String)];if(!(g===undefined)&&!(g===null)){return true;}e++;}return false;}h=new($sliceType($String))(["identity_type","identity_name","identity_auth"]);i=0;while(i<h.$length){j=((i<0||i>=h.$length)?$throwRuntimeError("index out of range"):h.$array[h.$offset+i]);k=a.sessionParams[$externalize(j,$String)];if((k===undefined)||(k===null)){return false;}i++;}return true;};AR.prototype.canLogin=function(){return this.$val.canLogin();};AR.Ptr.prototype.makeCreateSessionAction=function(){var a=$ifaceNil,b;b=this;a=b.sessionParams;a.action=$externalize("create_session",$String);return a;};AR.prototype.makeCreateSessionAction=function(){return this.$val.makeCreateSessionAction();};AR.Ptr.prototype.makeResumeSessionAction=function(a){var b=$ifaceNil,c;c=this;b=U();b.action=$externalize("resume_session",$String);b.event_id=$externalize(c.receivedEventId,$Uint64);if(a){b.session_id=c.sessionId;}c.sendEventAck=false;c.ackedEventId=c.receivedEventId;return b;};AR.prototype.makeResumeSessionAction=function(a){return this.$val.makeResumeSessionAction(a);};AR.Ptr.prototype.handleSessionEvent=function(a){var b=false,c,d,e,f,g,h,i,j,k,l,m;c=this;d=G(a);e=d[0];f=d[1];g=d[2];h=d[3];b=d[4];i=d[5];if(!($interfaceIsEqual(i,$ifaceNil))){c.log(new($sliceType($emptyInterface))([new $String("session creation:"),i]));}if(!R("NinchatClient.Session onSessionEvent callback",c.onSessionEvent,new($sliceType($emptyInterface))([a]))){b=false;}if(!b){c.Close();return b;}c.sessionParams.user_id=e;if(!(f===$ifaceNil)){c.sessionParams.user_auth=f;}j=new($sliceType($String))(["identity_type","identity_name","identity_auth"]);k=0;while(k<j.$length){l=((k<0||k>=j.$length)?$throwRuntimeError("index out of range"):j.$array[j.$offset+k]);m=c.sessionParams[$externalize(l+"_new",$String)];if(!(m===undefined)){c.sessionParams[$externalize(l,$String)]=m;}k++;}delete c.sessionParams[$externalize("access_key",$String)];delete c.sessionParams[$externalize("master_sign",$String)];c.sessionId=g;c.receivedEventId=h;c.log(new($sliceType($emptyInterface))([new $String("session created")]));b=true;return b;};AR.prototype.handleSessionEvent=function(a){return this.$val.handleSessionEvent(a);};AR.Ptr.prototype.handleEvent=function(a,b){var c=new $Uint64(0,0),d=false,e=false,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w;f=this;g=I(a);h=g[0];c=g[1];i=g[2];if(!($interfaceIsEqual(i,$ifaceNil))){f.log(new($sliceType($emptyInterface))([new $String("event:"),i]));return[c,d,e];}if((h.$high>0||(h.$high===0&&h.$low>0))){f.receivedEventId=h;if(!f.sendEventAck){if((j=(k=f.receivedEventId,l=f.ackedEventId,new $Uint64(k.$high-l.$high,k.$low-l.$low)),(j.$high>AP.$high||(j.$high===AP.$high&&j.$low>=AP.$low)))){f.sendAck();}else{d=true;}}}if((c.$high>0||(c.$high===0&&c.$low>0))){m=C.Search(f.numSent,(function(m){var n,o,p;o=(n=f.sendBuffer,((m<0||m>=n.$length)?$throwRuntimeError("index out of range"):n.$array[n.$offset+m]));return(p=o.Id,(p.$high>c.$high||(p.$high===c.$high&&p.$low>=c.$low)));}));if(m<f.numSent){o=(n=f.sendBuffer,((m<0||m>=n.$length)?$throwRuntimeError("index out of range"):n.$array[n.$offset+m]));if((p=o.Id,(p.$high===c.$high&&p.$low===c.$low))){f.resolve(o,true,new($sliceType($emptyInterface))([a,b]));q=J(a,o);r=q[0];s=q[1];if(!($interfaceIsEqual(s,$ifaceNil))){f.log(new($sliceType($emptyInterface))([new $String("event:"),s]));return[c,d,e];}if(r){f.sendBuffer=$appendSlice($subslice(f.sendBuffer,0,m),$subslice(f.sendBuffer,(m+1>>0)));f.numSent=f.numSent-(1)>>0;}}}}t=K(a);u=t[0];v=t[1];w=t[2];i=t[3];if(!($interfaceIsEqual(i,$ifaceNil))){f.log(new($sliceType($emptyInterface))([new $String("event:"),i]));if(w){if(f.canLogin()){f.reset();}else{R("NinchatClient.Session onSessionEvent callback",f.onSessionEvent,new($sliceType($emptyInterface))([a]));f.Close();}}return[c,d,e];}if(u==="deprecated"){f.log(new($sliceType($emptyInterface))([new $String("deprecated:"),new $String(v)]));}if(!R("NinchatClient.Session onEvent callback",f.onEvent,new($sliceType($emptyInterface))([a,b]))){return[c,d,e];}e=true;return[c,d,e];};AR.prototype.handleEvent=function(a,b){return this.$val.handleEvent(a,b);};AR.Ptr.prototype.resolve=function(a,b,c){var $deferred=[],$err=null,d;try{$deferFrames.push($deferred);d=this;$deferred.push([(function(){var e;e=$recover();if(!($interfaceIsEqual(e,$ifaceNil))){console.log(e);}}),[]]);if(!(a.Resolve===$throwNilPointerError)){a.Resolve(b,c);}}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);}};AR.prototype.resolve=function(a,b,c){return this.$val.resolve(a,b,c);};AR.Ptr.prototype.connState=function(a){var b;b=this;if(!(b.latestConnState===a)){b.latestConnState=a;if(!(b.onConnState===$ifaceNil)){R("NinchatClient.Session onConnState callback",b.onConnState,new($sliceType($emptyInterface))([new $String(b.latestConnState)]));}}};AR.prototype.connState=function(a){return this.$val.connState(a);};AR.Ptr.prototype.connActive=function(){var a;a=this;a.latestConnActive=AV();if(!(a.onConnActive===$ifaceNil)){R("NinchatClient.Session onConnActive callback",a.onConnActive,new($sliceType($emptyInterface))([a.latestConnActive]));}};AR.prototype.connActive=function(){return this.$val.connActive();};AR.Ptr.prototype.log=function(a){var b;b=this;AF("NinchatClient.Session onLog callback",b.onLog,a);};AR.prototype.log=function(a){return this.$val.log(a);};AV=$pkg.Now=function(){var a;return(a=$internalize(new($global.Date)().getTime(),$Int64),new AT(a.$high,a.$low));};AX=$pkg.NewTimer=function(a){var b=($ptrType(AW)).nil;b=new AW.Ptr(new($chanType($Bool,false,false))(0),$ifaceNil);if((a.$high>0||(a.$high===0&&a.$low>=0))){b.Reset(a);}return b;};AW.Ptr.prototype.Active=function(){var a;a=this;return!(a.id===$ifaceNil);};AW.prototype.Active=function(){return this.$val.Active();};AW.Ptr.prototype.Reset=function(a){var b;b=this;b.Stop();b.id=Z((function(){b.id=$ifaceNil;$go((function($b){var $this=this,$args=arguments,$r,$s=0;if(!$b){$nonblockingCall();};var $f=function(){while(true){switch($s){case 0:$r=$send(b.C,true,true);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[]);}),a);};AW.prototype.Reset=function(a){return this.$val.Reset(a);};AW.Ptr.prototype.Stop=function(){var a;a=this;if(!(a.id===$ifaceNil)){AA(a.id);a.id=$ifaceNil;}};AW.prototype.Stop=function(){return this.$val.Stop();};AY=$pkg.Sleep=function(a,$b){var $this=this,$args=arguments,$r,$s=0,b;if(!$b){$nonblockingCall();};var $f=function(){while(true){switch($s){case 0:b=$recv(AX(a).C,true);$s=1;case 1:if(b&&b.$blocking){b=b();}b[0];case-1:}return;}};$f.$blocking=true;return $f;};BA=$pkg.NewWebSocket=function(a){var b=($ptrType(AZ)).nil;b=new AZ.Ptr(new($chanType($Bool,false,false))(1),new($global.WebSocket)($externalize(a,$String)),($sliceType(B.Object)).nil);b.impl.binaryType=$externalize("arraybuffer",$String);b.impl.onopen=$externalize((function(){$go((function($b){var $this=this,$args=arguments,$r,$s=0;if(!$b){$nonblockingCall();};var $f=function(){while(true){switch($s){case 0:$r=$send(b.Notify,true,true);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[]);}),($funcType([B.Object],[],false)));b.impl.onmessage=$externalize((function(c){b.buffer=$append(b.buffer,c.data);$go((function(){var d;d=$select([[b.Notify,true],[]]);}),[]);}),($funcType([B.Object],[],false)));b.impl.onclose=$externalize((function(){$go((function(){$close(b.Notify);}),[]);}),($funcType([B.Object],[],false)));return b;};AZ.Ptr.prototype.Send=function(a){var b=$ifaceNil,$deferred=[],$err=null,c;try{$deferFrames.push($deferred);c=this;$deferred.push([(function(){b=Q($recover());}),[]]);c.impl.send($externalize(a,$emptyInterface));return b;}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return b;}};AZ.prototype.Send=function(a){return this.$val.Send(a);};AZ.Ptr.prototype.SendJSON=function(a){var b=$ifaceNil,c,d,e;c=this;d=X(a);e=d[0];b=d[1];if(!($interfaceIsEqual(b,$ifaceNil))){return b;}b=c.Send(new $String(e));return b;};AZ.prototype.SendJSON=function(a){return this.$val.SendJSON(a);};AZ.Ptr.prototype.Receive=function(){var a=$ifaceNil,b,c;b=this;if(b.buffer.$length>0){a=(c=b.buffer,((0<0||0>=c.$length)?$throwRuntimeError("index out of range"):c.$array[c.$offset+0]));b.buffer=$subslice(b.buffer,1);}return a;};AZ.prototype.Receive=function(){return this.$val.Receive();};AZ.Ptr.prototype.ReceiveJSON=function(){var a=$ifaceNil,b=$ifaceNil,c,d,e;c=this;d=c.Receive();if(d===$ifaceNil){return[a,b];}e=W(BB(d));a=e[0];b=e[1];return[a,b];};AZ.prototype.ReceiveJSON=function(){return this.$val.ReceiveJSON();};AZ.Ptr.prototype.Close=function(){var a=$ifaceNil,$deferred=[],$err=null,b;try{$deferFrames.push($deferred);b=this;$deferred.push([(function(){a=Q($recover());}),[]]);b.impl.close();return a;}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return a;}};AZ.prototype.Close=function(){return this.$val.Close();};BB=$pkg.StringifyFrame=function(a){var b="",c,d,e,f;c=$assertType($internalize(a,$emptyInterface),$String,true);b=c[0];d=c[1];if(d){return b;}e=T(a);f=$assertType($internalize(e,$emptyInterface),($sliceType($Uint8)));b=$bytesToString(f);return b;};BC=$pkg.WebSocketTransport=function(a,b,$b){var $this=this,$args=arguments,c=false,d=false,$r,$deferred=[],$err=null,$s=0,e,f,g,h,i,j,k,l;if(!$b){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);while(true){switch($s){case 0:e=($ptrType(AZ)).nil;$deferred.push([(function(){if(!(e===($ptrType(AZ)).nil)){e.Close();}}),[true]]);f=AX(new AU(-1,4294967295));$deferred.push([$methodVal(f,"Stop"),[true]]);case 1:if(!(true)){$s=2;continue;}d=false;g=false;a.log(new($sliceType($emptyInterface))([new $String("connecting to"),new $String(b)]));e=BA("wss://"+b+"/v2/socket");f.Reset(O(new AU(0,9000),0.1));i=$select([[e.Notify],[f.C],[a.closeNotify]],true);$s=3;case 3:if(i&&i.$blocking){i=i();}h=i;if(h[0]===0){}else if(h[0]===1){$s=4;continue;}else if(h[0]===2){$s=5;continue;}else{$s=6;continue;}j=h[1][0];f.Stop();if(j){}else{$s=7;continue;}a.log(new($sliceType($emptyInterface))([new $String("connected")]));a.connState("connected");c=true;l=BD(a,e,true);$s=9;case 9:if(l&&l.$blocking){l=l();}k=l;d=k[0];g=k[1];$s=8;continue;case 7:a.log(new($sliceType($emptyInterface))([new $String("connection failed")]));case 8:$s=6;continue;case 4:a.log(new($sliceType($emptyInterface))([new $String("connection timeout")]));$s=6;continue;case 5:f.Stop();case 6:e.Close();e=($ptrType(AZ)).nil;a.log(new($sliceType($emptyInterface))([new $String("disconnected")]));if(!d||!g||a.closed){return[c,d];}$s=1;continue;case 2:case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);return[c,d];}};$f.$blocking=true;return $f;};BD=function(a,b,$b){var $this=this,$args=arguments,c=false,d=false,$r,$s=0,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s;if(!$b){$nonblockingCall();};var $f=function(){while(true){switch($s){case 0:a.binarySupported=true;e=$ifaceNil;if(a.sessionId===$ifaceNil){a.log(new($sliceType($emptyInterface))([new $String("session creation")]));e=a.makeCreateSessionAction();}else{a.log(new($sliceType($emptyInterface))([new $String("session resumption")]));e=a.makeResumeSessionAction(true);}f=b.SendJSON(e);if(!($interfaceIsEqual(f,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("send:"),f]));}if(a.sessionId===$ifaceNil){}else{$s=1;continue;}g=$ifaceNil;h=AX(O(new AU(0,13000),0.2));case 2:if(!(true)){$s=3;continue;}i=$ifaceNil;j=b.ReceiveJSON();g=j[0];i=j[1];if(!($interfaceIsEqual(i,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("session creation:"),i]));return[c,d];}if(!(g===$ifaceNil)){h.Stop();$s=3;continue;}l=$select([[b.Notify],[h.C]],true);$s=4;case 4:if(l&&l.$blocking){l=l();}k=l;if(k[0]===0){m=k[1][0];if(!m){a.log(new($sliceType($emptyInterface))([new $String("disconnected during session creation")]));h.Stop();return[c,d];}}else if(k[0]===1){a.log(new($sliceType($emptyInterface))([new $String("session creation timeout")]));return[c,d];}$s=2;continue;case 3:if(!a.handleSessionEvent(g)){return[c,d];}c=true;d=true;a.connActive();case 1:n=new($chanType($Bool,false,false))(1);o=new($chanType($Bool,false,false))(0);$go(BE,[a,b,n,o]);q=BF(a,b,n,true);$s=5;case 5:if(q&&q.$blocking){q=q();}p=q;r=p[0];d=p[1];if(r){c=true;}s=$recv(o,true);$s=6;case 6:if(s&&s.$blocking){s=s();}s[0];return[c,d];case-1:}return;}};$f.$blocking=true;return $f;};BE=function(a,b,c,d,$b){var $this=this,$args=arguments,$r,$deferred=[],$err=null,$s=0,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z;if(!$b){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);while(true){switch($s){case 0:$deferred.push([(function($b){var $this=this,$args=arguments,$r,$s=0;if(!$b){$nonblockingCall();};var $f=function(){while(true){switch($s){case 0:$r=$send(d,true,true);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[true]]);e=AX(O(new AU(0,56000),-0.3));$deferred.push([$methodVal(e,"Stop"),[true]]);case 1:if(!(true)){$s=2;continue;}case 3:if(!(a.numSent<a.sendBuffer.$length)){$s=4;continue;}h=(f=a.sendBuffer,g=a.numSent,((g<0||g>=f.$length)?$throwRuntimeError("index out of range"):f.$array[f.$offset+g]));if(!(h.Payload===$ifaceNil)){h.Header.frames=$parseInt(h.Payload.length);}if(!((i=a.receivedEventId,j=a.ackedEventId,(i.$high===j.$high&&i.$low===j.$low)))){h.Header.event_id=$externalize(a.receivedEventId,$Uint64);a.sendEventAck=false;a.ackedEventId=a.receivedEventId;}k=b.SendJSON(h.Header);delete h.Header[$externalize("frames",$String)];delete h.Header[$externalize("event_id",$String)];if(!($interfaceIsEqual(k,$ifaceNil))){}else{$s=5;continue;}a.log(new($sliceType($emptyInterface))([new $String("send:"),k]));$r=$send(c,true,true);$s=6;case 6:if($r&&$r.$blocking){$r=$r();}return;case 5:if(!(h.Payload===$ifaceNil)){}else{$s=7;continue;}l=0;case 8:if(!(l<$parseInt(h.Payload.length))){$s=9;continue;}m=b.Send(h.Payload[0]);if(!($interfaceIsEqual(m,$ifaceNil))){}else{$s=10;continue;}a.log(new($sliceType($emptyInterface))([new $String("send:"),m]));$r=$send(c,true,true);$s=11;case 11:if($r&&$r.$blocking){$r=$r();}return;case 10:l=l+(1)>>0;$s=8;continue;case 9:case 7:if((n=h.Id,(n.$high===0&&n.$low===0))){a.sendBuffer=$appendSlice($subslice(a.sendBuffer,0,a.numSent),$subslice(a.sendBuffer,(a.numSent+1>>0)));}else{a.numSent=a.numSent+(1)>>0;}e.Reset(O(new AU(0,56000),-0.3));$s=3;continue;case 4:if(a.sendEventAck&&!((o=a.receivedEventId,p=a.ackedEventId,(o.$high===p.$high&&o.$low===p.$low)))){}else{$s=12;continue;}q=a.makeResumeSessionAction(false);r=b.SendJSON(q);if(!($interfaceIsEqual(r,$ifaceNil))){}else{$s=13;continue;}a.log(new($sliceType($emptyInterface))([new $String("send:"),r]));$r=$send(c,true,true);$s=14;case 14:if($r&&$r.$blocking){$r=$r();}return;case 13:case 12:t=$select([[a.sendNotify],[e.C],[c]],true);$s=15;case 15:if(t&&t.$blocking){t=t();}s=t;if(s[0]===0){}else if(s[0]===1){$s=16;continue;}else if(s[0]===2){$s=17;continue;}else{$s=18;continue;}u=s[1][0];if(!u){v=(w=new $Map(),x="action",w[x]={k:x,v:new $String("close_session")},w);y=b.SendJSON(new($mapType($String,$emptyInterface))(v));if(!($interfaceIsEqual(y,$ifaceNil))){a.log(new($sliceType($emptyInterface))([new $String("send:"),y]));}return;}$s=18;continue;case 16:z=b.Send(new($sliceType($Uint8))([]));if(!($interfaceIsEqual(z,$ifaceNil))){}else{$s=19;continue;}a.log(new($sliceType($emptyInterface))([new $String("send:"),z]));$r=$send(c,true,true);$s=20;case 20:if($r&&$r.$blocking){$r=$r();}return;case 19:e.Reset(O(new AU(0,56000),-0.3));$s=18;continue;case 17:return;case 18:$s=1;continue;case 2:case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);}};$f.$blocking=true;return $f;};BF=function(a,b,c,$b){var $this=this,$args=arguments,d=false,e=false,$r,$deferred=[],$err=null,$s=0,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z;if(!$b){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);while(true){switch($s){case 0:f=$ifaceNil;g=$ifaceNil;h=0;i=AX(O(new AU(0,64000),0.3));$deferred.push([$methodVal(i,"Stop"),[true]]);j=AX(new AU(-1,4294967295));$deferred.push([$methodVal(j,"Stop"),[true]]);case 1:if(!(true)){$s=2;continue;}k=false;case 3:if(!(true)){$s=4;continue;}if(f===$ifaceNil){}else{$s=5;continue;}l=$ifaceNil;m=b.Receive();if(m===$ifaceNil){$s=4;continue;}i.Reset(O(new AU(0,64000),0.7));a.connActive();n=BB(m);if(n.length===0){$s=3;continue;}o=W(n);f=o[0];l=o[1];if(!($interfaceIsEqual(l,$ifaceNil))){}else{$s=7;continue;}a.log(new($sliceType($emptyInterface))([new $String("receive:"),l]));e=false;$r=$send(c,true,true);$s=8;case 8:if($r&&$r.$blocking){$r=$r();}return[d,e];case 7:g=S();p=H(f);h=p[0];l=p[1];if(!($interfaceIsEqual(l,$ifaceNil))){}else{$s=9;continue;}a.log(new($sliceType($emptyInterface))([new $String("receive:"),l]));e=false;$r=$send(c,true,true);$s=10;case 10:if($r&&$r.$blocking){$r=$r();}return[d,e];case 9:$s=6;continue;case 5:q=b.Receive();if(q===$ifaceNil){$s=4;continue;}g.push(q);h=h-(1)>>0;case 6:if(h===0){}else{$s=11;continue;}r=a.handleEvent(f,g);s=r[1];t=r[2];if(!t){}else{$s=12;continue;}e=false;$r=$send(c,true,true);$s=13;case 13:if($r&&$r.$blocking){$r=$r();}return[d,e];case 12:if(s){k=true;}f=$ifaceNil;g=$ifaceNil;h=0;d=true;e=true;case 11:u=$select([[a.closeNotify],[c],[]]);if(u[0]===0){return[d,e];}else if(u[0]===1){return[d,e];}$s=3;continue;case 4:if(k&&!j.Active()){j.Reset(O(new AU(0,7000),-0.3));}w=$select([[b.Notify],[i.C],[j.C],[a.closeNotify],[c]],true);$s=14;case 14:if(w&&w.$blocking){w=w();}v=w;if(v[0]===0){}else if(v[0]===1){$s=15;continue;}else if(v[0]===2){$s=16;continue;}else if(v[0]===3){$s=17;continue;}else if(v[0]===4){$s=18;continue;}else{$s=19;continue;}x=v[1][0];if(!x){}else{$s=20;continue;}$r=$send(c,true,true);$s=21;case 21:if($r&&$r.$blocking){$r=$r();}return[d,e];case 20:$s=19;continue;case 15:a.log(new($sliceType($emptyInterface))([new $String("receive timeout")]));$r=$send(c,true,true);$s=22;case 22:if($r&&$r.$blocking){$r=$r();}return[d,e];$s=19;continue;case 16:if(!a.sendEventAck&&!((y=a.ackedEventId,z=a.receivedEventId,(y.$high===z.$high&&y.$low===z.$low)))){a.sendAck();}$s=19;continue;case 17:return[d,e];$s=19;continue;case 18:return[d,e];case 19:$s=1;continue;case 2:case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);return[d,e];}};$f.$blocking=true;return $f;};$pkg.$run=function($b){$packages["github.com/gopherjs/gopherjs/js"].$init();$packages["runtime"].$init();$packages["errors"].$init();$packages["sort"].$init();$pkg.$init();AL();};$pkg.$init=function(){($ptrType(D)).methods=[["Name","Name","",$funcType([],[$String],false),-1]];D.init([["Id","Id","",$Uint64,""],["Header","Header","",B.Object,""],["Payload","Payload","",B.Object,""],["Resolve","Resolve","",AM,""],["name","name","ninchatclient",$String,""]]);($ptrType(L)).methods=[["Failure","Failure","",$funcType([AU],[AU],false),-1],["Success","Success","",$funcType([],[],false),-1]];L.init([["lastSlot","lastSlot","ninchatclient",$Int,""]]);AM.init([$Bool,($sliceType($emptyInterface))],[],true);($ptrType(AN)).methods=[["Resolve","Resolve","",$funcType([$Bool,($sliceType($emptyInterface))],[],true),-1],["Then","Then","",$funcType([B.Object,B.Object],[],false),-1]];AN.init([["settled","settled","ninchatclient",$Bool,""],["successful","successful","ninchatclient",$Bool,""],["args","args","ninchatclient",($sliceType($emptyInterface)),""],["successCallbacks","successCallbacks","ninchatclient",($sliceType(B.Object)),""],["failureCallbacks","failureCallbacks","ninchatclient",($sliceType(B.Object)),""]]);AQ.init([($ptrType(AR)),$String],[$Bool,$Bool],false);($ptrType(AR)).methods=[["BinarySupported","BinarySupported","",$funcType([],[$Bool],false),-1],["Close","Close","",$funcType([],[],false),-1],["OnConnActive","OnConnActive","",$funcType([B.Object],[],false),-1],["OnConnState","OnConnState","",$funcType([B.Object],[],false),-1],["OnEvent","OnEvent","",$funcType([B.Object],[],false),-1],["OnLog","OnLog","",$funcType([B.Object],[],false),-1],["OnSessionEvent","OnSessionEvent","",$funcType([B.Object],[],false),-1],["Open","Open","",$funcType([],[],false),-1],["Send","Send","",$funcType([B.Object,B.Object],[B.Object],false),-1],["SetAddress","SetAddress","",$funcType([B.Object],[],false),-1],["SetParams","SetParams","",$funcType([B.Object],[],false),-1],["SetTransport","SetTransport","",$funcType([B.Object],[],false),-1],["canLogin","canLogin","ninchatclient",$funcType([],[$Bool],false),-1],["connActive","connActive","ninchatclient",$funcType([],[],false),-1],["connState","connState","ninchatclient",$funcType([$String],[],false),-1],["connect","connect","ninchatclient",$funcType([AQ,($sliceType($String)),($ptrType(L))],[$Bool],false),-1],["discover","discover","ninchatclient",$funcType([],[],false),-1],["handleEvent","handleEvent","ninchatclient",$funcType([B.Object,B.Object],[$Uint64,$Bool,$Bool],false),-1],["handleSessionEvent","handleSessionEvent","ninchatclient",$funcType([B.Object],[$Bool],false),-1],["log","log","ninchatclient",$funcType([($sliceType($emptyInterface))],[],true),-1],["makeCreateSessionAction","makeCreateSessionAction","ninchatclient",$funcType([],[B.Object],false),-1],["makeResumeSessionAction","makeResumeSessionAction","ninchatclient",$funcType([$Bool],[B.Object],false),-1],["reset","reset","ninchatclient",$funcType([],[],false),-1],["resolve","resolve","ninchatclient",$funcType([($ptrType(D)),$Bool,($sliceType($emptyInterface))],[],true),-1],["send","send","ninchatclient",$funcType([($ptrType(D))],[],false),-1],["sendAck","sendAck","ninchatclient",$funcType([],[],false),-1]];AR.init([["onSessionEvent","onSessionEvent","ninchatclient",B.Object,""],["onEvent","onEvent","ninchatclient",B.Object,""],["onConnState","onConnState","ninchatclient",B.Object,""],["onConnActive","onConnActive","ninchatclient",B.Object,""],["onLog","onLog","ninchatclient",B.Object,""],["address","address","ninchatclient",$String,""],["forceLongPoll","forceLongPoll","ninchatclient",$Bool,""],["sessionParams","sessionParams","ninchatclient",B.Object,""],["sessionId","sessionId","ninchatclient",B.Object,""],["binarySupported","binarySupported","ninchatclient",$Bool,""],["latestConnState","latestConnState","ninchatclient",$String,""],["latestConnActive","latestConnActive","ninchatclient",AT,""],["lastActionId","lastActionId","ninchatclient",$Uint64,""],["sendNotify","sendNotify","ninchatclient",($chanType($Bool,false,false)),""],["sendBuffer","sendBuffer","ninchatclient",($sliceType(($ptrType(D)))),""],["numSent","numSent","ninchatclient",$Int,""],["sendEventAck","sendEventAck","ninchatclient",$Bool,""],["receivedEventId","receivedEventId","ninchatclient",$Uint64,""],["ackedEventId","ackedEventId","ninchatclient",$Uint64,""],["closeNotify","closeNotify","ninchatclient",($chanType($Bool,false,false)),""],["closed","closed","ninchatclient",$Bool,""]]);($ptrType(AW)).methods=[["Active","Active","",$funcType([],[$Bool],false),-1],["Reset","Reset","",$funcType([AU],[],false),-1],["Stop","Stop","",$funcType([],[],false),-1]];AW.init([["C","C","",($chanType($Bool,false,false)),""],["id","id","ninchatclient",B.Object,""]]);($ptrType(AZ)).methods=[["Close","Close","",$funcType([],[$error],false),-1],["Receive","Receive","",$funcType([],[B.Object],false),-1],["ReceiveJSON","ReceiveJSON","",$funcType([],[B.Object,$error],false),-1],["Send","Send","",$funcType([$emptyInterface],[$error],false),-1],["SendJSON","SendJSON","",$funcType([$emptyInterface],[$error],false),-1]];AZ.init([["Notify","Notify","",($chanType($Bool,false,false)),""],["impl","impl","ninchatclient",B.Object,""],["buffer","buffer","ninchatclient",($sliceType(B.Object)),""]]);AB=0;AK=U();AP=P(new $Uint64(0,4096),-0.25);$pkg.WebSocketSupported=!($global.WebSocket===undefined);};return $pkg;})();
