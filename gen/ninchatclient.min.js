...
$packages["ninchatclient"]=(function(){var $pkg={},A,B,C,BI,BJ,BK,BL,BM,BN,BO,BP,BQ,BR,BS,BT,BU,BV,BW,BX,BY,BZ,CA,CB,CC,CD,CE,CF,CG,CH,CI,CJ,CK,CL,D,L,AL,AO,AP,AR,AS,AU,AX,AJ,AN,BE,E,F,G,H,I,J,K,M,N,O,P,Q,R,S,T,U,V,W,X,Z,AA,AB,AC,AD,AE,AF,AG,AH,AI,AK,AM,AQ,AT,AV,AW,AY,AZ,BA,BB,BC,BD,BF,BG,BH;A=$packages["errors"];B=$packages["github.com/gopherjs/gopherjs/js"];C=$packages["sort"];D=$pkg.Action=$newType(0,$kindStruct,"main.Action","Action","ninchatclient",function(Id_,Header_,Payload_,Deferred_,name_){this.$val=this;this.Id=Id_!==undefined?Id_:new $Uint64(0,0);this.Header=Header_!==undefined?Header_:null;this.Payload=Payload_!==undefined?Payload_:null;this.Deferred=Deferred_!==undefined?Deferred_:BS.nil;this.name=name_!==undefined?name_:"";});L=$pkg.Backoff=$newType(0,$kindStruct,"main.Backoff","Backoff","ninchatclient",function(lastSlot_){this.$val=this;this.lastSlot=lastSlot_!==undefined?lastSlot_:0;});AL=$pkg.Deferred=$newType(0,$kindStruct,"main.Deferred","Deferred","ninchatclient",function(resolve_,reject_,notify_){this.$val=this;this.resolve=resolve_!==undefined?resolve_:BT.nil;this.reject=reject_!==undefined?reject_:BT.nil;this.notify=notify_!==undefined?notify_:BT.nil;});AO=$pkg.Transport=$newType(4,$kindFunc,"main.Transport","Transport","ninchatclient",null);AP=$pkg.Session=$newType(0,$kindStruct,"main.Session","Session","ninchatclient",function(onSessionEvent_,onEvent_,onConnState_,onConnActive_,onLog_,address_,forceLongPoll_,sessionParams_,sessionId_,latestConnState_,latestConnActive_,lastActionId_,sendNotify_,sendBuffer_,numSent_,sendEventAck_,receivedEventId_,ackedEventId_,closeNotify_,closed_,stopped_){this.$val=this;this.onSessionEvent=onSessionEvent_!==undefined?onSessionEvent_:null;this.onEvent=onEvent_!==undefined?onEvent_:null;this.onConnState=onConnState_!==undefined?onConnState_:null;this.onConnActive=onConnActive_!==undefined?onConnActive_:null;this.onLog=onLog_!==undefined?onLog_:null;this.address=address_!==undefined?address_:"";this.forceLongPoll=forceLongPoll_!==undefined?forceLongPoll_:false;this.sessionParams=sessionParams_!==undefined?sessionParams_:null;this.sessionId=sessionId_!==undefined?sessionId_:null;this.latestConnState=latestConnState_!==undefined?latestConnState_:"";this.latestConnActive=latestConnActive_!==undefined?latestConnActive_:new AR(0,0);this.lastActionId=lastActionId_!==undefined?lastActionId_:new $Uint64(0,0);this.sendNotify=sendNotify_!==undefined?sendNotify_:BV.nil;this.sendBuffer=sendBuffer_!==undefined?sendBuffer_:BX.nil;this.numSent=numSent_!==undefined?numSent_:0;this.sendEventAck=sendEventAck_!==undefined?sendEventAck_:false;this.receivedEventId=receivedEventId_!==undefined?receivedEventId_:new $Uint64(0,0);this.ackedEventId=ackedEventId_!==undefined?ackedEventId_:new $Uint64(0,0);this.closeNotify=closeNotify_!==undefined?closeNotify_:BV.nil;this.closed=closed_!==undefined?closed_:false;this.stopped=stopped_!==undefined?stopped_:false;});AR=$pkg.Time=$newType(8,$kindInt64,"main.Time","Time","ninchatclient",null);AS=$pkg.Duration=$newType(8,$kindInt64,"main.Duration","Duration","ninchatclient",null);AU=$pkg.Timer=$newType(0,$kindStruct,"main.Timer","Timer","ninchatclient",function(C_,id_){this.$val=this;this.C=C_!==undefined?C_:BV.nil;this.id=id_!==undefined?id_:null;});AX=$pkg.WebSocket=$newType(0,$kindStruct,"main.WebSocket","WebSocket","ninchatclient",function(Notify_,impl_,open_,error_,buffer_){this.$val=this;this.Notify=Notify_!==undefined?Notify_:BV.nil;this.impl=impl_!==undefined?impl_:null;this.open=open_!==undefined?open_:false;this.error=error_!==undefined?error_:$ifaceNil;this.buffer=buffer_!==undefined?buffer_:BT.nil;});D.Ptr.prototype.Name=function(){var a;a=this;if(a.name===""){a.name=$internalize(a.Header.action,$String);}return a.name;};D.prototype.Name=function(){return this.$val.Name();};E=$pkg.GetAddress=function(a){if(a===undefined||a===null){return"api.ninchat.com";}else{return $internalize(a,$String);}};F=$pkg.GetEndpointHosts=function(a){var $deferred=[],$err=null,b=BI.nil,c=$ifaceNil,d,e,f,g;try{$deferFrames.push($deferred);$deferred.push([(function(){var d;d=Q($recover());if(!($interfaceIsEqual(d,$ifaceNil))){c=d;}}),[]]);d=Z(a);e=d[0];c=d[1];if(!($interfaceIsEqual(c,$ifaceNil))){return[b,c];}f=e.hosts;if($parseInt(f.length)===0){c=A.New("endpoint hosts array is empty");return[b,c];}b=BI.make($parseInt(f.length));g=0;while(g<$parseInt(f.length)){(g<0||g>=b.$length)?$throwRuntimeError("index out of range"):b.$array[b.$offset+g]=$internalize(f[g],$String);g=g+(1)>>0;}return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};G=$pkg.GetSessionEventCredentials=function(a){var $deferred=[],$err=null,b=null,c=null,d=null,e=new $Uint64(0,0),f=false,g=$ifaceNil,h;try{$deferFrames.push($deferred);$deferred.push([(function(){var h;h=Q($recover());if(!($interfaceIsEqual(h,$ifaceNil))){g=h;}}),[]]);if(!($internalize(a.event,$String)==="session_created")){return[b,c,d,e,f,g];}b=a.user_id;h=a.user_auth;if(!(h===undefined)){c=h;}d=a.session_id;e=$internalize(a.event_id,$Uint64);f=true;return[b,c,d,e,f,g];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c,d,e,f,g];}};H=$pkg.GetEventFrames=function(a){var $deferred=[],$err=null,b=0,c=$ifaceNil,d;try{$deferFrames.push($deferred);$deferred.push([(function(){c=Q($recover());}),[]]);d=a.frames;if(!(d===undefined)){b=$parseInt(d)>>0;if(b<0){b=0;}}return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};I=$pkg.GetEventAndActionId=function(a){var $deferred=[],$err=null,b=new $Uint64(0,0),c=new $Uint64(0,0),d=$ifaceNil,e,f;try{$deferFrames.push($deferred);$deferred.push([(function(){d=Q($recover());}),[]]);e=a.event_id;if(!(e===undefined)){b=$internalize(e,$Uint64);}f=a.action_id;if(!(f===undefined)){c=$internalize(f,$Uint64);}return[b,c,d];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c,d];}};J=$pkg.IsEventLastReply=function(a,b){var $deferred=[],$err=null,c=false,d=$ifaceNil,e,f,g;try{$deferFrames.push($deferred);$deferred.push([(function(){d=Q($recover());}),[]]);c=true;e=a.history_length;if(!(e===undefined)){if(($parseInt(e)>>0)>0){c=false;}}if(b.name==="search"){f=a.users;g=a.channels;if(!(f===undefined)||!(g===undefined)){c=false;}}return[c,d];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[c,d];}};K=$pkg.GetEventError=function(a){var $deferred=[],$err=null,b="",c="",d=false,e=$ifaceNil,f,g;try{$deferFrames.push($deferred);$deferred.push([(function(){var f;f=Q($recover());if(!($interfaceIsEqual(f,$ifaceNil))){e=f;}}),[]]);if(!($internalize(a.event,$String)==="error")){return[b,c,d,e];}b=$internalize(a.error_type,$String);f=a.error_reason;if(!(f===undefined)){c=$internalize(f,$String);}g=b;if(g==="session_not_found"){d=true;if(!(c==="")){e=A.New("error: "+b+" ("+c+")");}else{e=A.New("error: "+b);}}else if(g==="connection_superseded"||g==="message_has_too_many_parts"||g==="message_part_too_long"||g==="message_too_long"||g==="request_malformed"){if(!(c==="")){e=A.New("error: "+b+" ("+c+")");}else{e=A.New("error: "+b);}}return[b,c,d,e];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c,d,e];}};L.Ptr.prototype.Success=function(){var a;a=this;a.lastSlot=0;};L.prototype.Success=function(){return this.$val.Success();};L.Ptr.prototype.Failure=function(a){var b=new AS(0,0),c;c=this;if(c.lastSlot>0){b=new AS(0,N($flatten64(a)*c.lastSlot/1024,-0.5));}if(c.lastSlot<1023){c.lastSlot=((((c.lastSlot+1>>0))<<1>>0))-1>>0;}return b;};L.prototype.Failure=function(a){return this.$val.Failure(a);};M=$pkg.Call=function(a,b,c){var d=$ifaceNil,e,f,g;e="https://"+E(c)+"/v2/call";f=AM();g=f[0];d=new BJ(f[1]);$go((function($b){var $args=arguments,$r,$s=0,$this=this,h,i,j,k,l,m,n,o,p,q;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:h=BH(e,a,O(new AS(0,11000),0.1));i=h[0];j=h[1];if(!($interfaceIsEqual(j,$ifaceNil))){AE("NinchatClient.call onLog callback",b,new BK([new $String("call:"),j]));g.Reject(new BK([]));return;}l=$recv(i,$BLOCKING);$s=1;case 1:if(l&&l.$blocking){l=l();}k=l;m=k[0];n=k[1];if(m===""){if(n){AE("NinchatClient.call onLog callback",b,new BK([new $String("call error")]));}else{AE("NinchatClient.call onLog callback",b,new BK([new $String("call timeout")]));}g.Reject(new BK([]));return;}o=Z(m);p=o[0];j=o[1];if(!($interfaceIsEqual(j,$ifaceNil))){AE("NinchatClient.call onLog callback",b,new BK([new $String("call response:"),j]));g.Reject(new BK([]));return;}q=U();q.push(p);g.Resolve(new BK([q]));case-1:}return;}};$f.$blocking=true;return $f;}),[]);return d;};N=$pkg.Jitter=function(a,b){return a+a*b*AB();};O=$pkg.JitterDuration=function(a,b){return new AS(0,N($flatten64(a),b));};P=$pkg.JitterUint64=function(a,b){return new $Uint64(0,N($flatten64(a),b));};Q=function(a){var b=$ifaceNil,c,d,e,f;if($interfaceIsEqual(a,$ifaceNil)){return b;}c=$assertType(a,BL,true);d=c[0];e=c[1];if(e){f=$internalize(d.Object.message,$String);if(f===""){f="error";}b=A.New(f);return b;}b=$assertType(a,$error);return b;};R=function(a,b,c){var $deferred=[],$err=null,d=false;try{$deferFrames.push($deferred);$deferred.push([(function(){var e;e=Q($recover());if(!($interfaceIsEqual(e,$ifaceNil))){console.log(a+" invocation error: "+e.Error());}}),[]]);b.apply(undefined,$externalize(c,BK));d=true;return d;}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return d;}};S=$pkg.Atob=function(a){var $deferred=[],$err=null,b=null,c=$ifaceNil;try{$deferFrames.push($deferred);$deferred.push([(function(){c=Q($recover());}),[]]);b=$global.atob(a);return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};T=$pkg.ParseDataURI=function(a){var $deferred=[],$err=null,b=null,c=$ifaceNil;try{$deferFrames.push($deferred);$deferred.push([(function(){c=Q($recover());}),[]]);b=a.split($externalize(",",$String))[1];return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};U=$pkg.NewArray=function(){return new($global.Array)();};V=$pkg.NewArrayBuffer=function(a){return new($global.ArrayBuffer)(a);};W=$pkg.NewUint8Array=function(a){return new($global.Uint8Array)(a);};X=$pkg.NewObject=function(){return new($global.Object)();};Z=$pkg.ParseJSON=function(a){var $deferred=[],$err=null,b=null,c=$ifaceNil;try{$deferFrames.push($deferred);$deferred.push([(function(){c=Q($recover());}),[]]);b=$global.JSON.parse($externalize(a,$String));return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};AA=$pkg.StringifyJSON=function(a){var $deferred=[],$err=null,b="",c=$ifaceNil;try{$deferFrames.push($deferred);$deferred.push([(function(){c=Q($recover());}),[]]);b=$internalize($global.JSON.stringify($externalize(a,$emptyInterface)),$String);return[b,c];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[b,c];}};AB=$pkg.Random=function(){return $parseFloat($global.Math.random());};AC=$pkg.SetTimeout=function(a,b){var c=null;c=$global.setTimeout($externalize(a,BM),$externalize(b,AS));return c;};AD=$pkg.ClearTimeout=function(a){$global.clearTimeout(a);};AE=$pkg.Log=function(a,b,c){var d,e,f,g,h,i,j,k,l,m,n;if(b===undefined||b===null){return;}d="";e=c;f=0;while(f<e.$length){g=((f<0||f>=e.$length)?$throwRuntimeError("index out of range"):e.$array[e.$offset+f]);h="?";i=$assertType(g,$String,true);j=i[0];k=i[1];if(k){h=j;}else{l=$assertType(g,$error,true);m=l[0];n=l[1];if(n){h=m.Error();}}if(d.length>0){d=d+(" ");}d=d+(h);f++;}while(d.length>0&&(d.charCodeAt((d.length-1>>0))===32)){d=d.substring(0,(d.length-1>>0));}R(a,b,new BK([new $String(d)]));};AF=$pkg.LongPollTransport=function(a,b,$b){var $args=arguments,$deferred=[],$err=null,$r,$s=0,$this=this,c=false,d=false,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);s:while(true){switch($s){case 0:$deferred.push([(function(){var e;e=Q($recover());if(!($interfaceIsEqual(e,$ifaceNil))){a.log(new BK([new $String("poll:"),e]));}}),[$BLOCKING]]);e="https://"+b+"/v2/poll";if(a.sessionId===null){}else{$s=1;continue;}a.log(new BK([new $String("session creation")]));f=a.makeCreateSessionAction();g=BH(e,f,O(new AS(0,13000),0.2));h=g[0];i=g[1];if(!($interfaceIsEqual(i,$ifaceNil))){a.log(new BK([new $String("session creation:"),i]));return[c,d];}k=$select([[h],[a.closeNotify]],$BLOCKING);$s=3;case 3:if(k&&k.$blocking){k=k();}j=k;if(j[0]===0){l=j[1];m=l[0];n=l[1];if(!n){a.log(new BK([new $String("session creation timeout")]));return[c,d];}else if(m===""){a.log(new BK([new $String("session creation error")]));return[c,d];}o=Z(m);p=o[0];q=o[1];if(!($interfaceIsEqual(q,$ifaceNil))){a.log(new BK([new $String("session creation response:"),q]));return[c,d];}r=p[0];if(!a.handleSessionEvent(r)){return[c,d];}}else if(j[0]===1){AI(a,e);return[c,d];}c=true;d=true;a.connState("connected");a.connActive();$s=2;continue;case 1:a.log(new BK([new $String("session resumption")]));s=AH(a,e);if(!($interfaceIsEqual(s,$ifaceNil))){a.log(new BK([new $String("session resumption:"),s]));return[c,d];}case 2:$r=AG(a,e,new BN(function(){return c;},function($v){c=$v;}),new BN(function(){return d;},function($v){d=$v;}),$BLOCKING);$s=4;case 4:if($r&&$r.$blocking){$r=$r();}return[c,d];case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);return[c,d];}};$f.$blocking=true;return $f;};AG=function(a,b,c,d,$b){var $args=arguments,$r,$s=0,$this=this,aa,ab,ac,ad,ae,af,ag,ah,ai,aj,ak,al,am,an,ao,ap,aq,ar,as,at,au,av,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:e=BO.nil;f=BO.nil;g=new $Uint64(0,0);h=0;a.numSent=0;case 1:if(!(h<2)){$s=2;continue;}if(e===BO.nil){i=$ifaceNil;j=a.makeResumeSessionAction(true);k=BH(b,j,O(new AS(0,64000),0.2));e=k[0];i=k[1];if(!($interfaceIsEqual(i,$ifaceNil))){a.log(new BK([new $String("poll:"),i]));return;}}if(f===BO.nil&&a.numSent<a.sendBuffer.$length){n=(l=a.sendBuffer,m=a.numSent,((m<0||m>=l.$length)?$throwRuntimeError("index out of range"):l.$array[l.$offset+m]));if(!(n.Payload===null)){o=null;p=$ifaceNil;q=n.Payload[0];if($internalize(n.Header.action,$String)==="update_user"){r=T(q);s=r[0];t=r[1];if(!($interfaceIsEqual(t,$ifaceNil))){a.log(new BK([new $String("send:"),t]));return;}o=U();o.push(s);}else{u=Z($internalize(q,$String));o=u[0];p=u[1];if(!($interfaceIsEqual(p,$ifaceNil))){a.log(new BK([new $String("send:"),p]));return;}}n.Header.payload=o;}n.Header.session_id=a.sessionId;v=AA(n.Header);w=v[0];x=v[1];delete n.Header[$externalize("session_id",$String)];delete n.Header[$externalize("payload",$String)];if(!($interfaceIsEqual(x,$ifaceNil))){a.log(new BK([new $String("send:"),x]));return;}y=BG(b,w,O(new AS(0,7000),0.2));z=y[0];x=y[1];if(!($interfaceIsEqual(x,$ifaceNil))){a.log(new BK([new $String("send:"),x]));return;}if((aa=n.Id,(aa.$high===0&&aa.$low===0))){a.sendBuffer=$appendSlice($subslice(a.sendBuffer,0,a.numSent),$subslice(a.sendBuffer,(a.numSent+1>>0)));}else{f=z;g=n.Id;}}ab="";ac=false;ae=$select([[e],[f],[a.sendNotify],[a.closeNotify]],$BLOCKING);$s=3;case 3:if(ae&&ae.$blocking){ae=ae();}ad=ae;if(ad[0]===0){af=ad[1];ab=af[0];ac=af[1];if(!ac){a.log(new BK([new $String("poll timeout")]));}else if(ab===""){a.log(new BK([new $String("poll error")]));}e=BO.nil;a.connActive();}else if(ad[0]===1){ag=ad[1];ab=ag[0];ac=ag[1];if(!ac){a.log(new BK([new $String("send timeout")]));}else if(ab===""){a.log(new BK([new $String("send error")]));}else if((g.$high>0||(g.$high===0&&g.$low>0))){a.numSent=a.numSent+(1)>>0;}f=BO.nil;g=new $Uint64(0,0);}else if(ad[0]===2){ah=ad[1][0];if(!ah){AI(a,b);return;}$s=1;continue;}else if(ad[0]===3){AI(a,b);return;}ai=null;if(!(ab==="")){aj=$ifaceNil;ak=Z(ab);ai=ak[0];aj=ak[1];if(!($interfaceIsEqual(aj,$ifaceNil))){a.log(new BK([new $String("response:"),aj]));}}if(ai===null){h=h+(1)>>0;a.numSent=0;$s=1;continue;}h=0;c.$set(true);al=0;while(al<$parseInt(ai.length)){am=ai[al];an=U();ao=am.payload;if(!(ao===undefined)){ap=AA(ao);aq=ap[0];ar=ap[1];if(!($interfaceIsEqual(ar,$ifaceNil))){a.log(new BK([new $String("poll payload:"),ar]));return;}an.push($externalize(aq,$String));}as=a.handleEvent(am,an);at=as[0];au=as[1];av=as[3];if((g.$high>0||(g.$high===0&&g.$low>0))&&(g.$high<at.$high||(g.$high===at.$high&&g.$low<=at.$low))){g=new $Uint64(0,0);a.numSent=a.numSent+(1)>>0;}if(!av){if(au){d.$set(true);}return;}if(!d.$get()){d.$set(true);a.connState("connected");}al=al+(1)>>0;}$s=1;continue;case 2:return;case-1:}return;}};$f.$blocking=true;return $f;};AH=function(a,b){var c=$ifaceNil,d,e,f,g;d=(e=new $Map(),f="action",e[f]={k:f,v:new $String("ping")},f="session_id",e[f]={k:f,v:a.sessionId},e);g=BH(b,new BJ(d),O(new AS(0,7000),0.9));c=g[1];return c;};AI=function(a,b){var c,d,e,f,g;c=(d=new $Map(),e="action",d[e]={k:e,v:new $String("close_session")},e="session_id",d[e]={k:e,v:a.sessionId},d);f=BH(b,new BJ(c),O(new AS(0,7000),0.9));g=f[1];if(!($interfaceIsEqual(g,$ifaceNil))){a.log(new BK([new $String("send:"),g]));}};AK=function(){AJ.call=$externalize(M,BP);AJ.newSession=$externalize(AQ,BQ);AJ.stringifyFrame=$externalize(AZ,BR);$global.NinchatClient=AJ;};AM=$pkg.Defer=function(){var a=BS.nil,b=false,c,d;a=new AL.Ptr(BT.nil,BT.nil,BT.nil);b=(c=new $Map(),d="then",c[d]={k:d,v:new BU($methodVal(a,"then"))},c);return[a,b];};AL.Ptr.prototype.then=function(a,b,c){var d;d=this;if(!(a===undefined)&&!(a===null)){d.resolve=$append(d.resolve,a);}if(!(b===undefined)&&!(b===null)){d.reject=$append(d.reject,b);}if(!(c===undefined)&&!(c===null)){d.notify=$append(d.notify,c);}};AL.prototype.then=function(a,b,c){return this.$val.then(a,b,c);};AL.Ptr.prototype.Resolve=function(a){var b,c,d,e;b=this;c=b.resolve;d=0;while(d<c.$length){e=((d<0||d>=c.$length)?$throwRuntimeError("index out of range"):c.$array[c.$offset+d]);R("NinchatClient promise resolve callback",e,a);d++;}};AL.prototype.Resolve=function(a){return this.$val.Resolve(a);};AL.Ptr.prototype.Reject=function(a){var b,c,d,e;b=this;c=b.reject;d=0;while(d<c.$length){e=((d<0||d>=c.$length)?$throwRuntimeError("index out of range"):c.$array[c.$offset+d]);R("NinchatClient promise reject callback",e,a);d++;}};AL.prototype.Reject=function(a){return this.$val.Reject(a);};AL.Ptr.prototype.Notify=function(a){var b,c,d,e;b=this;c=b.notify;d=0;while(d<c.$length){e=((d<0||d>=c.$length)?$throwRuntimeError("index out of range"):c.$array[c.$offset+d]);R("NinchatClient promise notify callback",e,a);d++;}};AL.prototype.Notify=function(a){return this.$val.Notify(a);};AQ=$pkg.NewSession=function(){var a,b,c;a=new AP.Ptr(null,null,null,null,null,"api.ninchat.com",false,null,null,"",new AR(0,0),new $Uint64(0,0),BV.nil,BX.nil,0,false,new $Uint64(0,0),new $Uint64(0,0),BV.nil,false,true);return(b=new $Map(),c="onSessionEvent",b[c]={k:c,v:new BY($methodVal(a,"OnSessionEvent"))},c="onEvent",b[c]={k:c,v:new BY($methodVal(a,"OnEvent"))},c="onConnState",b[c]={k:c,v:new BY($methodVal(a,"OnConnState"))},c="onConnActive",b[c]={k:c,v:new BY($methodVal(a,"OnConnActive"))},c="onLog",b[c]={k:c,v:new BY($methodVal(a,"OnLog"))},c="setParams",b[c]={k:c,v:new BZ($methodVal(a,"SetParams"))},c="setTransport",b[c]={k:c,v:new CA($methodVal(a,"SetTransport"))},c="setAddress",b[c]={k:c,v:new CB($methodVal(a,"SetAddress"))},c="open",b[c]={k:c,v:new BM($methodVal(a,"Open"))},c="close",b[c]={k:c,v:new BM($methodVal(a,"Close"))},c="send",b[c]={k:c,v:new CC($methodVal(a,"Send"))},b);};AP.Ptr.prototype.OnSessionEvent=function(a){var b;b=this;b.onSessionEvent=a;};AP.prototype.OnSessionEvent=function(a){return this.$val.OnSessionEvent(a);};AP.Ptr.prototype.OnEvent=function(a){var b;b=this;b.onEvent=a;};AP.prototype.OnEvent=function(a){return this.$val.OnEvent(a);};AP.Ptr.prototype.OnConnState=function(a){var b;b=this;if(a===null){a=null;}b.onConnState=a;if(!(b.onConnState===null)&&!(b.latestConnState==="")){R("NinchatClient.Session onConnState callback",b.onConnState,new BK([new $String(b.latestConnState)]));}};AP.prototype.OnConnState=function(a){return this.$val.OnConnState(a);};AP.Ptr.prototype.OnConnActive=function(a){var b,c;b=this;if(a===null){a=null;}b.onConnActive=a;if(!(b.onConnActive===null)&&(c=b.latestConnActive,(c.$high>0||(c.$high===0&&c.$low>0)))){R("NinchatClient.Session onConnActive callback",b.onConnActive,new BK([b.latestConnActive]));}};AP.prototype.OnConnActive=function(a){return this.$val.OnConnActive(a);};AP.Ptr.prototype.OnLog=function(a){var b;b=this;if(a===null){a=null;}b.onLog=a;};AP.prototype.OnLog=function(a){return this.$val.OnLog(a);};AP.Ptr.prototype.SetParams=function(a){var b,c;b=this;if(a.message_types===undefined){$panic(new $String("message_types parameter not defined"));}c=a.session_id;if(!(c===undefined)&&!(c===null)){b.sessionId=c;}delete a[$externalize("session_id",$String)];b.sessionParams=a;if(!(b.sendNotify===BV.nil)&&b.stopped){$go($methodVal(b,"discover"),[]);}};AP.prototype.SetParams=function(a){return this.$val.SetParams(a);};AP.Ptr.prototype.SetTransport=function(a){var b,c,d;b=this;if(a===null){b.forceLongPoll=false;return;}c=$internalize(a,$String);d=c;if(d==="websocket"){$panic(new $String("websocket transport cannot be forced"));}else if(d==="longpoll"){b.forceLongPoll=true;}else{$panic(new $String("unknown transport: "+c));}};AP.prototype.SetTransport=function(a){return this.$val.SetTransport(a);};AP.Ptr.prototype.SetAddress=function(a){var b;b=this;b.address=E(a);};AP.prototype.SetAddress=function(a){return this.$val.SetAddress(a);};AP.Ptr.prototype.Open=function(){var a;a=this;if(a.closed){$panic(new $String("session already closed"));}if(!(a.sendNotify===BV.nil)){$panic(new $String("session already initialized"));}if(a.onSessionEvent===null){$panic(new $String("onSessionEvent callback not defined"));}if(a.onEvent===null){$panic(new $String("onEvent callback not defined"));}if(a.sessionParams===null){$panic(new $String("session parameters not defined"));}a.sendNotify=new BV(1);a.closeNotify=new BV(1);a.stopped=false;$go($methodVal(a,"discover"),[]);};AP.prototype.Open=function(){return this.$val.Open();};AP.Ptr.prototype.Close=function(){var a,b,c,d;a=this;if(a.closed){return;}b=a.sendBuffer;c=0;while(c<b.$length){d=((c<0||c>=b.$length)?$throwRuntimeError("index out of range"):b.$array[b.$offset+c]);if(!(d.Deferred===BS.nil)){d.Deferred.Reject(new BK([]));}c++;}a.sendBuffer=BX.nil;a.numSent=0;a.closed=true;a.stopped=true;$go((function($b){var $args=arguments,$r,$s=0,$this=this;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:$r=$send(a.closeNotify,true,$BLOCKING);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}$close(a.sendNotify);case-1:}return;}};$f.$blocking=true;return $f;}),[]);};AP.prototype.Close=function(){return this.$val.Close();};AP.Ptr.prototype.Send=function(a,b){var c=$ifaceNil,d,e,f,g,h;d=this;if(d.sendNotify===BV.nil){$panic(new $String("session not initialized"));}if(d.closed){$panic(new $String("session already closed"));}if(b===undefined||b===null||($parseInt(b.length)===0)){b=null;}e=new D.Ptr(new $Uint64(0,0),a,b,BS.nil,"");if(a.action_id===null){delete a[$externalize("action_id",$String)];}else{d.lastActionId=(f=d.lastActionId,g=new $Uint64(0,1),new $Uint64(f.$high+g.$high,f.$low+g.$low));e.Id=d.lastActionId;a.action_id=$externalize(e.Id,$Uint64);h=AM();e.Deferred=h[0];c=new BJ(h[1]);}d.send(e);return c;};AP.prototype.Send=function(a,b){return this.$val.Send(a,b);};AP.Ptr.prototype.send=function(a){var b;b=this;b.sendBuffer=$append(b.sendBuffer,a);$go((function(){var c;c=$select([[b.sendNotify,true],[]]);}),[]);return;};AP.prototype.send=function(a){return this.$val.send(a);};AP.Ptr.prototype.sendAck=function(){var a;a=this;a.sendEventAck=true;$go((function(){var b;b=$select([[a.sendNotify,true],[]]);}),[]);};AP.prototype.sendAck=function(){return this.$val.sendAck();};AP.Ptr.prototype.discover=function($b){var $args=arguments,$deferred=[],$err=null,$r,$s=0,$this=this,a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);s:while(true){switch($s){case 0:a=$this;a.log(new BK([new $String("opening")]));$deferred.push([$methodVal(a,"log"),[new BK([new $String("closed")]),$BLOCKING]]);$deferred.push([$methodVal(a,"connState"),["disconnected",$BLOCKING]]);b=$clone(new L.Ptr(),L);case 1:if(!(!a.stopped)){$s=2;continue;}a.log(new BK([new $String("endpoint discovery")]));a.connState("connecting");c="https://"+a.address+"/v2/endpoint";d=BG(c,"",O(new AS(0,7000),0.1));e=d[0];f=d[1];if(!($interfaceIsEqual(f,$ifaceNil))){}else{$s=3;continue;}a.log(new BK([new $String("endpoint discovery:"),f]));$s=4;continue;case 3:h=$select([[e],[a.closeNotify]],$BLOCKING);$s=5;case 5:if(h&&h.$blocking){h=h();}g=h;if(g[0]===0){}else if(g[0]===1){$s=6;continue;}else{$s=7;continue;}i=g[1];j=i[0];k=i[1];if(!k){}else if(j===""){$s=8;continue;}else{$s=9;continue;}a.log(new BK([new $String("endpoint discovery timeout")]));$s=10;continue;case 8:a.log(new BK([new $String("endpoint discovery error")]));$s=10;continue;case 9:l=F(j);m=l[0];n=l[1];if(!($interfaceIsEqual(n,$ifaceNil))){}else{$s=11;continue;}a.log(new BK([new $String("endpoint discovery:"),n]));$s=12;continue;case 11:a.log(new BK([new $String("endpoint discovered")]));if($pkg.WebSocketSupported&&!a.forceLongPoll){}else{$s=13;continue;}o=a.connect(BA,m,b,$BLOCKING);$s=14;case 14:if(o&&o.$blocking){o=o();}if(o){}else{$s=15;continue;}$s=1;continue;case 15:case 13:p=a.connect(AF,m,b,$BLOCKING);$s=16;case 16:if(p&&p.$blocking){p=p();}p;case 12:case 10:$s=7;continue;case 6:return;case 7:case 4:q=b.Failure(new AS(0,60000));if((q.$high>0||(q.$high===0&&q.$low>0))){}else{$s=17;continue;}a.log(new BK([new $String("sleeping")]));a.connState("disconnected");$r=AW(q,$BLOCKING);$s=18;case 18:if($r&&$r.$blocking){$r=$r();}case 17:$s=1;continue;case 2:case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);}};$f.$blocking=true;return $f;};AP.prototype.discover=function($b){return this.$val.discover($b);};AP.Ptr.prototype.connect=function(a,b,c,$b){var $args=arguments,$r,$s=0,$this=this,d=false,e,f,g,h,i,j,k,l,m,n;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:e=$this;f=0;case 1:if(!(f<2)){$s=2;continue;}g=b;h=0;case 3:if(!(h<g.$length)){$s=4;continue;}i=((h<0||h>=g.$length)?$throwRuntimeError("index out of range"):g.$array[g.$offset+h]);e.connState("connecting");k=a(e,i,$BLOCKING);$s=5;case 5:if(k&&k.$blocking){k=k();}j=k;l=j[0];m=j[1];if(l){d=true;}if(m){c.Success();return d;}if(e.stopped){return d;}n=c.Failure(new AS(0,60000));if((n.$high>0||(n.$high===0&&n.$low>0))){}else{$s=6;continue;}e.log(new BK([new $String("sleeping")]));e.connState("disconnected");$r=AW(n,$BLOCKING);$s=7;case 7:if($r&&$r.$blocking){$r=$r();}case 6:h++;$s=3;continue;case 4:f=f+(1)>>0;$s=1;continue;case 2:return d;case-1:}return;}};$f.$blocking=true;return $f;};AP.prototype.connect=function(a,b,c,$b){return this.$val.connect(a,b,c,$b);};AP.Ptr.prototype.canLogin=function(){var a,b,c,d,e,f,g,h,i,j,k;a=this;b=a.sessionParams.access_key;if(!(b===undefined)&&!(b===null)){return true;}c=a.sessionParams.user_id;if(!(c===undefined)&&!(c===null)){d=new BI(["user_auth","master_sign"]);e=0;while(e<d.$length){f=((e<0||e>=d.$length)?$throwRuntimeError("index out of range"):d.$array[d.$offset+e]);g=a.sessionParams[$externalize(f,$String)];if(!(g===undefined)&&!(g===null)){return true;}e++;}return false;}h=new BI(["identity_type","identity_name","identity_auth"]);i=0;while(i<h.$length){j=((i<0||i>=h.$length)?$throwRuntimeError("index out of range"):h.$array[h.$offset+i]);k=a.sessionParams[$externalize(j,$String)];if(k===undefined||k===null){return false;}i++;}return true;};AP.prototype.canLogin=function(){return this.$val.canLogin();};AP.Ptr.prototype.makeCreateSessionAction=function(){var a=null,b;b=this;a=b.sessionParams;a.action=$externalize("create_session",$String);return a;};AP.prototype.makeCreateSessionAction=function(){return this.$val.makeCreateSessionAction();};AP.Ptr.prototype.makeResumeSessionAction=function(a){var b=null,c;c=this;b=X();b.action=$externalize("resume_session",$String);b.event_id=$externalize(c.receivedEventId,$Uint64);if(a){b.session_id=c.sessionId;}c.sendEventAck=false;c.ackedEventId=c.receivedEventId;return b;};AP.prototype.makeResumeSessionAction=function(a){return this.$val.makeResumeSessionAction(a);};AP.Ptr.prototype.handleSessionEvent=function(a){var b=false,c,d,e,f,g,h,i,j,k,l,m;c=this;d=G(a);e=d[0];f=d[1];g=d[2];h=d[3];b=d[4];i=d[5];if(!($interfaceIsEqual(i,$ifaceNil))){c.log(new BK([new $String("session creation:"),i]));}if(!R("NinchatClient.Session onSessionEvent callback",c.onSessionEvent,new BK([a]))){b=false;}if(!b){c.sessionId=null;c.stopped=true;return b;}c.sessionParams.user_id=e;if(!(f===null)){c.sessionParams.user_auth=f;}j=new BI(["identity_type","identity_name","identity_auth"]);k=0;while(k<j.$length){l=((k<0||k>=j.$length)?$throwRuntimeError("index out of range"):j.$array[j.$offset+k]);m=c.sessionParams[$externalize(l+"_new",$String)];if(!(m===undefined)){c.sessionParams[$externalize(l,$String)]=m;}k++;}delete c.sessionParams[$externalize("access_key",$String)];delete c.sessionParams[$externalize("master_sign",$String)];c.sessionId=g;if(c.sendBuffer.$length===0){c.lastActionId=new $Uint64(0,0);}c.sendEventAck=false;c.receivedEventId=h;c.ackedEventId=new $Uint64(0,0);c.log(new BK([new $String("session created")]));b=true;return b;};AP.prototype.handleSessionEvent=function(a){return this.$val.handleSessionEvent(a);};AP.Ptr.prototype.handleEvent=function(a,b){var c=new $Uint64(0,0),d=false,e=false,f=false,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w;g=this;h=I(a);i=h[0];c=h[1];j=h[2];if(!($interfaceIsEqual(j,$ifaceNil))){g.log(new BK([new $String("event:"),j]));return[c,d,e,f];}if((i.$high>0||(i.$high===0&&i.$low>0))){g.receivedEventId=i;if(!g.sendEventAck){if((k=(l=g.receivedEventId,m=g.ackedEventId,new $Uint64(l.$high-m.$high,l.$low-m.$low)),(k.$high>AN.$high||(k.$high===AN.$high&&k.$low>=AN.$low)))){g.sendAck();}else{e=true;}}}if((c.$high>0||(c.$high===0&&c.$low>0))){n=C.Search(g.numSent,(function(n){var o,p,q;p=(o=g.sendBuffer,((n<0||n>=o.$length)?$throwRuntimeError("index out of range"):o.$array[o.$offset+n]));return(q=p.Id,(q.$high>c.$high||(q.$high===c.$high&&q.$low>=c.$low)));}));if(n<g.numSent){p=(o=g.sendBuffer,((n<0||n>=o.$length)?$throwRuntimeError("index out of range"):o.$array[o.$offset+n]));if((q=p.Id,(q.$high===c.$high&&q.$low===c.$low))){r=J(a,p);s=r[0];t=r[1];if(!($interfaceIsEqual(t,$ifaceNil))){g.log(new BK([new $String("event:"),t]));return[c,d,e,f];}if(!(p.Deferred===BS.nil)){if(s){p.Deferred.Resolve(new BK([a,b]));}else{p.Deferred.Notify(new BK([a,b]));}}if(s){g.sendBuffer=$appendSlice($subslice(g.sendBuffer,0,n),$subslice(g.sendBuffer,(n+1>>0)));g.numSent=g.numSent-(1)>>0;}}}}u=K(a);v=u[0];w=u[1];d=u[2];j=u[3];if(!($interfaceIsEqual(j,$ifaceNil))){g.log(new BK([new $String("event:"),j]));if(d){g.sessionId=null;if(!g.canLogin()){R("NinchatClient.Session onSessionEvent callback",g.onSessionEvent,new BK([a]));g.stopped=true;}}return[c,d,e,f];}if(v==="deprecated"){g.log(new BK([new $String("deprecated:"),new $String(w)]));}if(!R("NinchatClient.Session onEvent callback",g.onEvent,new BK([a,b]))){return[c,d,e,f];}f=true;return[c,d,e,f];};AP.prototype.handleEvent=function(a,b){return this.$val.handleEvent(a,b);};AP.Ptr.prototype.connState=function(a){var b;b=this;if(!(b.latestConnState===a)){b.latestConnState=a;if(!(b.onConnState===null)){R("NinchatClient.Session onConnState callback",b.onConnState,new BK([new $String(b.latestConnState)]));}}};AP.prototype.connState=function(a){return this.$val.connState(a);};AP.Ptr.prototype.connActive=function(){var a;a=this;a.latestConnActive=AT();if(!(a.onConnActive===null)){R("NinchatClient.Session onConnActive callback",a.onConnActive,new BK([a.latestConnActive]));}};AP.prototype.connActive=function(){return this.$val.connActive();};AP.Ptr.prototype.log=function(a){var b;b=this;AE("NinchatClient.Session onLog callback",b.onLog,a);};AP.prototype.log=function(a){return this.$val.log(a);};AT=$pkg.Now=function(){var a;return(a=$internalize(new($global.Date)().getTime(),$Int64),new AR(a.$high,a.$low));};AV=$pkg.NewTimer=function(a){var b=CD.nil;b=new AU.Ptr(new BV(0),null);if((a.$high>0||(a.$high===0&&a.$low>=0))){b.Reset(a);}return b;};AU.Ptr.prototype.Active=function(){var a;a=this;return!(a.id===null);};AU.prototype.Active=function(){return this.$val.Active();};AU.Ptr.prototype.Reset=function(a){var b;b=this;b.Stop();b.id=AC((function(){b.id=null;$go((function($b){var $args=arguments,$r,$s=0,$this=this;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:$r=$send(b.C,true,$BLOCKING);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[]);}),a);};AU.prototype.Reset=function(a){return this.$val.Reset(a);};AU.Ptr.prototype.Stop=function(){var a;a=this;if(!(a.id===null)){AD(a.id);a.id=null;}};AU.prototype.Stop=function(){return this.$val.Stop();};AW=$pkg.Sleep=function(a,$b){var $args=arguments,$r,$s=0,$this=this,b;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:b=$recv(AV(a).C,$BLOCKING);$s=1;case 1:if(b&&b.$blocking){b=b();}b[0];case-1:}return;}};$f.$blocking=true;return $f;};AY=$pkg.NewWebSocket=function(a){var b=CE.nil;b=new AX.Ptr(new BV(1),new($global.WebSocket)($externalize(a,$String)),false,$ifaceNil,BT.nil);b.impl.binaryType=$externalize("arraybuffer",$String);b.impl.onopen=$externalize((function(c){b.open=true;$go((function($b){var $args=arguments,$r,$s=0,$this=this;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:$r=$send(b.Notify,true,$BLOCKING);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[]);}),CF);b.impl.onmessage=$externalize((function(c){b.buffer=$append(b.buffer,c.data);$go((function(){var d;d=$select([[b.Notify,true],[]]);}),[]);}),CG);b.impl.onclose=$externalize((function(c){b.open=false;$go((function(){$close(b.Notify);}),[]);}),CF);b.impl.onerror=$externalize((function(c){b.error=A.New("WebSocket error event");}),CG);return b;};AX.Ptr.prototype.Send=function(a){var $deferred=[],$err=null,b=$ifaceNil,c;try{$deferFrames.push($deferred);c=this;$deferred.push([(function(){b=Q($recover());}),[]]);b=c.error;if(!($interfaceIsEqual(b,$ifaceNil))){return b;}c.impl.send($externalize(a,$emptyInterface));return b;}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return b;}};AX.prototype.Send=function(a){return this.$val.Send(a);};AX.Ptr.prototype.SendJSON=function(a){var b=$ifaceNil,c,d,e;c=this;d=AA(a);e=d[0];b=d[1];if(!($interfaceIsEqual(b,$ifaceNil))){return b;}b=c.Send(new $String(e));return b;};AX.prototype.SendJSON=function(a){return this.$val.SendJSON(a);};AX.Ptr.prototype.Receive=function(){var a=null,b=$ifaceNil,c,d;c=this;b=c.error;if(!($interfaceIsEqual(b,$ifaceNil))){return[a,b];}if(!c.open){return[a,b];}if(c.buffer.$length>0){a=(d=c.buffer,((0<0||0>=d.$length)?$throwRuntimeError("index out of range"):d.$array[d.$offset+0]));c.buffer=$subslice(c.buffer,1);}return[a,b];};AX.prototype.Receive=function(){return this.$val.Receive();};AX.Ptr.prototype.ReceiveJSON=function(){var a=null,b=$ifaceNil,c,d,e,f;c=this;d=c.Receive();e=d[0];b=d[1];if(!($interfaceIsEqual(b,$ifaceNil))||e===null){return[a,b];}f=Z(AZ(e));a=f[0];b=f[1];return[a,b];};AX.prototype.ReceiveJSON=function(){return this.$val.ReceiveJSON();};AX.Ptr.prototype.Close=function(){var $deferred=[],$err=null,a=$ifaceNil,b;try{$deferFrames.push($deferred);b=this;$deferred.push([(function(){a=Q($recover());}),[]]);b.impl.close();a=b.error;return a;}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return a;}};AX.prototype.Close=function(){return this.$val.Close();};AZ=$pkg.StringifyFrame=function(a){var b="",c,d,e,f;c=$assertType($internalize(a,$emptyInterface),$String,true);b=c[0];d=c[1];if(d){return b;}e=W(a);f=$assertType($internalize(e,$emptyInterface),CH);b=$bytesToString(f);return b;};BA=$pkg.WebSocketTransport=function(a,b,$b){var $args=arguments,$deferred=[],$err=null,$r,$s=0,$this=this,c=false,d=false,e,f,g,h,i,j,k,l;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);s:while(true){switch($s){case 0:e=CE.nil;$deferred.push([(function(){if(!(e===CE.nil)){e.Close();}}),[$BLOCKING]]);f=AV(new AS(-1,4294967295));$deferred.push([$methodVal(f,"Stop"),[$BLOCKING]]);case 1:if(!(true)){$s=2;continue;}d=false;g=false;a.log(new BK([new $String("connecting to"),new $String(b)]));e=AY("wss://"+b+"/v2/socket");f.Reset(O(new AS(0,9000),0.1));i=$select([[e.Notify],[f.C],[a.closeNotify]],$BLOCKING);$s=3;case 3:if(i&&i.$blocking){i=i();}h=i;if(h[0]===0){}else if(h[0]===1){$s=4;continue;}else if(h[0]===2){$s=5;continue;}else{$s=6;continue;}j=h[1][0];f.Stop();if(j){}else{$s=7;continue;}a.log(new BK([new $String("connected")]));a.connState("connected");c=true;l=BB(a,e,$BLOCKING);$s=9;case 9:if(l&&l.$blocking){l=l();}k=l;d=k[0];g=k[1];$s=8;continue;case 7:a.log(new BK([new $String("connection failed")]));case 8:$s=6;continue;case 4:a.log(new BK([new $String("connection timeout")]));$s=6;continue;case 5:f.Stop();case 6:e.Close();e=CE.nil;a.log(new BK([new $String("disconnected")]));if(!d||!g||a.stopped){return[c,d];}$s=1;continue;case 2:case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);return[c,d];}};$f.$blocking=true;return $f;};BB=function(a,b,$b){var $args=arguments,$r,$s=0,$this=this,c=false,d=false,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:e=null;if(a.sessionId===null){a.log(new BK([new $String("session creation")]));e=a.makeCreateSessionAction();}else{a.log(new BK([new $String("session resumption")]));e=a.makeResumeSessionAction(true);}f=b.SendJSON(e);if(!($interfaceIsEqual(f,$ifaceNil))){a.log(new BK([new $String("send:"),f]));}if(a.sessionId===null){}else{$s=1;continue;}g=null;h=AV(O(new AS(0,13000),0.2));case 2:if(!(true)){$s=3;continue;}i=$ifaceNil;j=b.ReceiveJSON();g=j[0];i=j[1];if(!($interfaceIsEqual(i,$ifaceNil))){a.log(new BK([new $String("session creation:"),i]));return[c,d];}if(!(g===null)){h.Stop();$s=3;continue;}l=$select([[b.Notify],[h.C]],$BLOCKING);$s=4;case 4:if(l&&l.$blocking){l=l();}k=l;if(k[0]===0){m=k[1][0];if(!m){a.log(new BK([new $String("disconnected during session creation")]));h.Stop();return[c,d];}}else if(k[0]===1){a.log(new BK([new $String("session creation timeout")]));return[c,d];}$s=2;continue;case 3:if(!a.handleSessionEvent(g)){return[c,d];}c=true;d=true;a.connActive();case 1:n=new BV(1);o=new BV(0);$go(BC,[a,b,n,o]);q=BD(a,b,n,$BLOCKING);$s=5;case 5:if(q&&q.$blocking){q=q();}p=q;r=p[0];d=p[1];if(r){c=true;}s=$recv(o,$BLOCKING);$s=6;case 6:if(s&&s.$blocking){s=s();}s[0];return[c,d];case-1:}return;}};$f.$blocking=true;return $f;};BC=function(a,b,c,d,$b){var $args=arguments,$deferred=[],$err=null,$r,$s=0,$this=this,aa,ab,ac,ad,ae,af,ag,ah,ai,aj,ak,al,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);s:while(true){switch($s){case 0:$deferred.push([(function($b){var $args=arguments,$r,$s=0,$this=this;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:$r=$send(d,true,$BLOCKING);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[$BLOCKING]]);e=AV(O(new AS(0,56000),-0.3));$deferred.push([$methodVal(e,"Stop"),[$BLOCKING]]);a.numSent=0;case 1:if(!(true)){$s=2;continue;}case 3:if(!(a.numSent<a.sendBuffer.$length)){$s=4;continue;}h=(f=a.sendBuffer,g=a.numSent,((g<0||g>=f.$length)?$throwRuntimeError("index out of range"):f.$array[f.$offset+g]));if(!(h.Payload===null)){h.Header.frames=$parseInt(h.Payload.length);}if(!((i=a.receivedEventId,j=a.ackedEventId,(i.$high===j.$high&&i.$low===j.$low)))){h.Header.event_id=$externalize(a.receivedEventId,$Uint64);a.sendEventAck=false;a.ackedEventId=a.receivedEventId;}k=b.SendJSON(h.Header);delete h.Header[$externalize("frames",$String)];delete h.Header[$externalize("event_id",$String)];if(!($interfaceIsEqual(k,$ifaceNil))){}else{$s=5;continue;}a.log(new BK([new $String("send:"),k]));$r=$send(c,true,$BLOCKING);$s=6;case 6:if($r&&$r.$blocking){$r=$r();}return;case 5:if(!(h.Payload===null)){}else{$s=7;continue;}l=0;case 8:if(!(l<$parseInt(h.Payload.length))){$s=9;continue;}m=h.Payload[l];if($internalize(h.Header.action,$String)==="update_user"){}else{$s=10;continue;}n=$assertType($internalize(m,$emptyInterface),$String,true);o=n[1];if(o){}else{$s=11;continue;}p=T(m);q=p[0];r=p[1];if(!($interfaceIsEqual(r,$ifaceNil))){}else{$s=12;continue;}a.log(new BK([new $String("send:"),r]));$r=$send(c,true,$BLOCKING);$s=13;case 13:if($r&&$r.$blocking){$r=$r();}return;case 12:s=S(q);t=s[0];r=s[1];if(!($interfaceIsEqual(r,$ifaceNil))){}else{$s=14;continue;}a.log(new BK([new $String("send:"),r]));$r=$send(c,true,$BLOCKING);$s=15;case 15:if($r&&$r.$blocking){$r=$r();}return;case 14:u=$parseInt(t.length);v=V(u);w=W(v);x=0;while(x<u){w[x]=t.charCodeAt(x);x=x+(1)>>0;}m=v;case 11:case 10:y=b.Send(m);if(!($interfaceIsEqual(y,$ifaceNil))){}else{$s=16;continue;}a.log(new BK([new $String("send:"),y]));$r=$send(c,true,$BLOCKING);$s=17;case 17:if($r&&$r.$blocking){$r=$r();}return;case 16:l=l+(1)>>0;$s=8;continue;case 9:case 7:if((z=h.Id,(z.$high===0&&z.$low===0))){a.sendBuffer=$appendSlice($subslice(a.sendBuffer,0,a.numSent),$subslice(a.sendBuffer,(a.numSent+1>>0)));}else{a.numSent=a.numSent+(1)>>0;}e.Reset(O(new AS(0,56000),-0.3));$s=3;continue;case 4:if(a.sendEventAck&&!((aa=a.receivedEventId,ab=a.ackedEventId,(aa.$high===ab.$high&&aa.$low===ab.$low)))){}else{$s=18;continue;}ac=a.makeResumeSessionAction(false);ad=b.SendJSON(ac);if(!($interfaceIsEqual(ad,$ifaceNil))){}else{$s=19;continue;}a.log(new BK([new $String("send:"),ad]));$r=$send(c,true,$BLOCKING);$s=20;case 20:if($r&&$r.$blocking){$r=$r();}return;case 19:case 18:af=$select([[a.sendNotify],[e.C],[c]],$BLOCKING);$s=21;case 21:if(af&&af.$blocking){af=af();}ae=af;if(ae[0]===0){}else if(ae[0]===1){$s=22;continue;}else if(ae[0]===2){$s=23;continue;}else{$s=24;continue;}ag=ae[1][0];if(!ag){ah=(ai=new $Map(),aj="action",ai[aj]={k:aj,v:new $String("close_session")},ai);ak=b.SendJSON(new BJ(ah));if(!($interfaceIsEqual(ak,$ifaceNil))){a.log(new BK([new $String("send:"),ak]));}return;}$s=24;continue;case 22:al=b.Send(new CI([]));if(!($interfaceIsEqual(al,$ifaceNil))){}else{$s=25;continue;}a.log(new BK([new $String("send:"),al]));$r=$send(c,true,$BLOCKING);$s=26;case 26:if($r&&$r.$blocking){$r=$r();}return;case 25:e.Reset(O(new AS(0,56000),-0.3));$s=24;continue;case 23:return;case 24:$s=1;continue;case 2:case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);}};$f.$blocking=true;return $f;};BD=function(a,b,c,$b){var $args=arguments,$deferred=[],$err=null,$r,$s=0,$this=this,aa,ab,ac,ad,d=false,e=false,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){try{$deferFrames.push($deferred);s:while(true){switch($s){case 0:f=null;g=null;h=0;i=AV(O(new AS(0,64000),0.3));$deferred.push([$methodVal(i,"Stop"),[$BLOCKING]]);j=AV(new AS(-1,4294967295));$deferred.push([$methodVal(j,"Stop"),[$BLOCKING]]);case 1:if(!(true)){$s=2;continue;}k=false;case 3:if(!(true)){$s=4;continue;}if(f===null){}else{$s=5;continue;}l=$ifaceNil;m=b.Receive();n=m[0];l=m[1];if(!($interfaceIsEqual(l,$ifaceNil))){}else{$s=7;continue;}a.log(new BK([new $String("receive:"),l]));e=false;$r=$send(c,true,$BLOCKING);$s=8;case 8:if($r&&$r.$blocking){$r=$r();}return[d,e];case 7:if(n===null){$s=4;continue;}i.Reset(O(new AS(0,64000),0.7));a.connActive();o=AZ(n);if(o.length===0){$s=3;continue;}p=Z(o);f=p[0];l=p[1];if(!($interfaceIsEqual(l,$ifaceNil))){}else{$s=9;continue;}a.log(new BK([new $String("receive:"),l]));e=false;$r=$send(c,true,$BLOCKING);$s=10;case 10:if($r&&$r.$blocking){$r=$r();}return[d,e];case 9:g=U();q=H(f);h=q[0];l=q[1];if(!($interfaceIsEqual(l,$ifaceNil))){}else{$s=11;continue;}a.log(new BK([new $String("receive:"),l]));e=false;$r=$send(c,true,$BLOCKING);$s=12;case 12:if($r&&$r.$blocking){$r=$r();}return[d,e];case 11:$s=6;continue;case 5:r=b.Receive();s=r[0];t=r[1];if(!($interfaceIsEqual(t,$ifaceNil))){}else{$s=13;continue;}a.log(new BK([new $String("receive:"),t]));e=false;$r=$send(c,true,$BLOCKING);$s=14;case 14:if($r&&$r.$blocking){$r=$r();}return[d,e];case 13:if(s===null){$s=4;continue;}g.push(s);h=h-(1)>>0;case 6:if(h===0){}else{$s=15;continue;}u=a.handleEvent(f,g);v=u[1];w=u[2];x=u[3];if(!x){}else{$s=16;continue;}if(v){d=true;}else{e=false;}$r=$send(c,true,$BLOCKING);$s=17;case 17:if($r&&$r.$blocking){$r=$r();}return[d,e];case 16:if(w){k=true;}f=null;g=null;h=0;d=true;e=true;case 15:y=$select([[a.closeNotify],[c],[]]);if(y[0]===0){return[d,e];}else if(y[0]===1){return[d,e];}$s=3;continue;case 4:if(k&&!j.Active()){j.Reset(O(new AS(0,7000),-0.3));}aa=$select([[b.Notify],[i.C],[j.C],[a.closeNotify],[c]],$BLOCKING);$s=18;case 18:if(aa&&aa.$blocking){aa=aa();}z=aa;if(z[0]===0){}else if(z[0]===1){$s=19;continue;}else if(z[0]===2){$s=20;continue;}else if(z[0]===3){$s=21;continue;}else if(z[0]===4){$s=22;continue;}else{$s=23;continue;}ab=z[1][0];if(!ab){}else{$s=24;continue;}$r=$send(c,true,$BLOCKING);$s=25;case 25:if($r&&$r.$blocking){$r=$r();}return[d,e];case 24:$s=23;continue;case 19:a.log(new BK([new $String("receive timeout")]));$r=$send(c,true,$BLOCKING);$s=26;case 26:if($r&&$r.$blocking){$r=$r();}return[d,e];$s=23;continue;case 20:if(!a.sendEventAck&&!((ac=a.ackedEventId,ad=a.receivedEventId,(ac.$high===ad.$high&&ac.$low===ad.$low)))){a.sendAck();}$s=23;continue;case 21:return[d,e];$s=23;continue;case 22:return[d,e];case 23:$s=1;continue;case 2:case-1:}return;}}catch(err){$err=err;}finally{$deferFrames.pop();if($curGoroutine.asleep&&!$jumpToDefer){throw null;}$s=-1;$callDeferred($deferred,$err);return[d,e];}};$f.$blocking=true;return $f;};BF=function(){BE=$global.XDomainRequest;if(BE===undefined){BE=$global.XMLHttpRequest;}};BG=$pkg.XHR=function(a,b,c){var $deferred=[],$err=null,d=CJ.nil,e=$ifaceNil,f,g;try{$deferFrames.push($deferred);$deferred.push([(function(){e=Q($recover());}),[]]);f="";if(b===""){f="GET";}else{f="POST";}d=new CJ(1);g=new(BE)();g.timeout=$externalize(c,AS);g.onload=$externalize((function(){var h,i;h="";i=g.responseText;if(!(i===undefined)&&!(i===null)){h=$internalize(i,$String);}$go((function($b){var $args=arguments,$r,$s=0,$this=this;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:$r=$send(d,h,$BLOCKING);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[]);}),BM);g.onprogress=$externalize((function(){}),BM);g.ontimeout=$externalize((function(){$go((function(){$close(d);}),[]);}),BM);g.onerror=$externalize((function(){$go((function($b){var $args=arguments,$r,$s=0,$this=this;if($b!==$BLOCKING){$nonblockingCall();};var $f=function(){s:while(true){switch($s){case 0:$r=$send(d,"",$BLOCKING);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}case-1:}return;}};$f.$blocking=true;return $f;}),[]);}),BM);g.open($externalize(f,$String),$externalize(a,$String));g.send($externalize(b,$String));return[d,e];}catch(err){$err=err;}finally{$deferFrames.pop();$callDeferred($deferred,$err);return[d,e];}};BH=$pkg.XHR_JSON=function(a,b,c){var d=CJ.nil,e=$ifaceNil,f,g,h;f=AA(b);g=f[0];e=f[1];if(!($interfaceIsEqual(e,$ifaceNil))){return[d,e];}h=BG(a,g,c);d=h[0];e=h[1];return[d,e];};$pkg.$init=function(){$pkg.$init=function(){};var $r,$s=0;var $init_main=function(){while(true){switch($s){case 0:$r=A.$init($BLOCKING);$s=1;case 1:if($r&&$r.$blocking){$r=$r();}$r=B.$init($BLOCKING);$s=2;case 2:if($r&&$r.$blocking){$r=$r();}$r=C.$init($BLOCKING);$s=3;case 3:if($r&&$r.$blocking){$r=$r();}BI=$sliceType($String);BJ=$mapType($String,$emptyInterface);BK=$sliceType($emptyInterface);BL=$ptrType(B.Error);BM=$funcType([],[],false);BN=$ptrType($Bool);BO=$chanType($String,false,true);BP=$funcType([B.Object,B.Object,B.Object],[$emptyInterface],false);BQ=$funcType([],[BJ],false);BR=$funcType([B.Object],[$String],false);BS=$ptrType(AL);BT=$sliceType(B.Object);BU=$funcType([B.Object,B.Object,B.Object],[],false);BV=$chanType($Bool,false,false);BW=$ptrType(D);BX=$sliceType(BW);BY=$funcType([B.Object],[],false);BZ=$funcType([B.Object],[],false);CA=$funcType([B.Object],[],false);CB=$funcType([B.Object],[],false);CC=$funcType([B.Object,B.Object],[$emptyInterface],false);CD=$ptrType(AU);CE=$ptrType(AX);CF=$funcType([B.Object],[],false);CG=$funcType([B.Object],[],false);CH=$sliceType($Uint8);CI=$sliceType($Uint8);CJ=$chanType($String,false,false);CK=$ptrType(L);CL=$ptrType(AP);BW.methods=[["Name","Name","",$funcType([],[$String],false),-1]];D.init([["Id","Id","",$Uint64,""],["Header","Header","",B.Object,""],["Payload","Payload","",B.Object,""],["Deferred","Deferred","",BS,""],["name","name","ninchatclient",$String,""]]);CK.methods=[["Failure","Failure","",$funcType([AS],[AS],false),-1],["Success","Success","",$funcType([],[],false),-1]];L.init([["lastSlot","lastSlot","ninchatclient",$Int,""]]);BS.methods=[["Notify","Notify","",$funcType([BK],[],true),-1],["Reject","Reject","",$funcType([BK],[],true),-1],["Resolve","Resolve","",$funcType([BK],[],true),-1],["then","then","ninchatclient",$funcType([B.Object,B.Object,B.Object],[],false),-1]];AL.init([["resolve","resolve","ninchatclient",BT,""],["reject","reject","ninchatclient",BT,""],["notify","notify","ninchatclient",BT,""]]);AO.init([CL,$String],[$Bool,$Bool],false);CL.methods=[["Close","Close","",$funcType([],[],false),-1],["OnConnActive","OnConnActive","",$funcType([B.Object],[],false),-1],["OnConnState","OnConnState","",$funcType([B.Object],[],false),-1],["OnEvent","OnEvent","",$funcType([B.Object],[],false),-1],["OnLog","OnLog","",$funcType([B.Object],[],false),-1],["OnSessionEvent","OnSessionEvent","",$funcType([B.Object],[],false),-1],["Open","Open","",$funcType([],[],false),-1],["Send","Send","",$funcType([B.Object,B.Object],[$emptyInterface],false),-1],["SetAddress","SetAddress","",$funcType([B.Object],[],false),-1],["SetParams","SetParams","",$funcType([B.Object],[],false),-1],["SetTransport","SetTransport","",$funcType([B.Object],[],false),-1],["canLogin","canLogin","ninchatclient",$funcType([],[$Bool],false),-1],["connActive","connActive","ninchatclient",$funcType([],[],false),-1],["connState","connState","ninchatclient",$funcType([$String],[],false),-1],["connect","connect","ninchatclient",$funcType([AO,BI,CK],[$Bool],false),-1],["discover","discover","ninchatclient",$funcType([],[],false),-1],["handleEvent","handleEvent","ninchatclient",$funcType([B.Object,B.Object],[$Uint64,$Bool,$Bool,$Bool],false),-1],["handleSessionEvent","handleSessionEvent","ninchatclient",$funcType([B.Object],[$Bool],false),-1],["log","log","ninchatclient",$funcType([BK],[],true),-1],["makeCreateSessionAction","makeCreateSessionAction","ninchatclient",$funcType([],[B.Object],false),-1],["makeResumeSessionAction","makeResumeSessionAction","ninchatclient",$funcType([$Bool],[B.Object],false),-1],["send","send","ninchatclient",$funcType([BW],[],false),-1],["sendAck","sendAck","ninchatclient",$funcType([],[],false),-1]];AP.init([["onSessionEvent","onSessionEvent","ninchatclient",B.Object,""],["onEvent","onEvent","ninchatclient",B.Object,""],["onConnState","onConnState","ninchatclient",B.Object,""],["onConnActive","onConnActive","ninchatclient",B.Object,""],["onLog","onLog","ninchatclient",B.Object,""],["address","address","ninchatclient",$String,""],["forceLongPoll","forceLongPoll","ninchatclient",$Bool,""],["sessionParams","sessionParams","ninchatclient",B.Object,""],["sessionId","sessionId","ninchatclient",B.Object,""],["latestConnState","latestConnState","ninchatclient",$String,""],["latestConnActive","latestConnActive","ninchatclient",AR,""],["lastActionId","lastActionId","ninchatclient",$Uint64,""],["sendNotify","sendNotify","ninchatclient",BV,""],["sendBuffer","sendBuffer","ninchatclient",BX,""],["numSent","numSent","ninchatclient",$Int,""],["sendEventAck","sendEventAck","ninchatclient",$Bool,""],["receivedEventId","receivedEventId","ninchatclient",$Uint64,""],["ackedEventId","ackedEventId","ninchatclient",$Uint64,""],["closeNotify","closeNotify","ninchatclient",BV,""],["closed","closed","ninchatclient",$Bool,""],["stopped","stopped","ninchatclient",$Bool,""]]);CD.methods=[["Active","Active","",$funcType([],[$Bool],false),-1],["Reset","Reset","",$funcType([AS],[],false),-1],["Stop","Stop","",$funcType([],[],false),-1]];AU.init([["C","C","",BV,""],["id","id","ninchatclient",B.Object,""]]);CE.methods=[["Close","Close","",$funcType([],[$error],false),-1],["Receive","Receive","",$funcType([],[B.Object,$error],false),-1],["ReceiveJSON","ReceiveJSON","",$funcType([],[B.Object,$error],false),-1],["Send","Send","",$funcType([$emptyInterface],[$error],false),-1],["SendJSON","SendJSON","",$funcType([$emptyInterface],[$error],false),-1]];AX.init([["Notify","Notify","",BV,""],["impl","impl","ninchatclient",B.Object,""],["open","open","ninchatclient",$Bool,""],["error","error","ninchatclient",$error,""],["buffer","buffer","ninchatclient",BT,""]]);BE=null;AJ=X();AN=P(new $Uint64(0,4096),-0.25);$pkg.WebSocketSupported=!($global.WebSocket===undefined);BF();AK();}return;}};$init_main.$blocking=true;return $init_main;};return $pkg;})();
